  ...
  (t = function () {
    ...
    const r = {
      ...
      isFull: function () {
        ...
        let t = 0,
          n = 0;
        return (
          this.document.forEach((e) => (t += e.length)),
          this.docs.forEach((e) => (n += e.length)),
          t === n
        );
      },
      getNth: function (e) {
    ...
    class View {
      ...
      update(e) {
        ...
        if (this._cache && e && e.length > 0) {
          ...
          e.forEach((e, t) => {
            let [r, a, o] = e;
            (1 === e.length || (0 === a && this.document[r].length === o)) &&
              (n[t] = this._cache[r]);
          }),
      ...
      fromText(e) {
        ...
        return (
          (r.world = this.world),
          r.compute(["normal", "freeze", "lexicon"]),
    ...
    function i(e, t) {
      if (o(t))
        for (const n in t)
          o(t[n])
            ? (e[n] || Object.assign(e, { [n]: {} }), i(e[n], t[n]))
            : Object.assign(e, { [n]: t[n] });
      return e;
    }
    const s = function (e, t, n, r) {
        const { methods: a, model: o, compute: s, hooks: l } = t;
        e.methods &&
          (function (e, t) {
          ...
          e.irregulars &&
            (function (e, t) {
              ...
              Object.keys(t).forEach((e) => {
                t[e].pastTense &&
                  (n.toPast && (n.toPast.ex[e] = t[e].pastTense),
                  n.fromPast && (n.fromPast.ex[t[e].pastTense] = e)),
                  t[e].presentTense &&
                    (n.toPresent && (n.toPresent.ex[e] = t[e].presentTense),
                    n.fromPresent && (n.fromPresent.ex[t[e].presentTense] = e)),
                  t[e].gerund &&
                    (n.toGerund && (n.toGerund.ex[e] = t[e].gerund),
                    n.fromGerund && (n.fromGerund.ex[t[e].gerund] = e)),
                  t[e].comparative &&
                    (n.toComparative &&
                      (n.toComparative.ex[e] = t[e].comparative),
                    n.fromComparative &&
                      (n.fromComparative.ex[t[e].comparative] = e)),
                  t[e].superlative &&
                    (n.toSuperlative &&
                      (n.toSuperlative.ex[e] = t[e].superlative),
                    n.fromSuperlative &&
                      (n.fromSuperlative.ex[t[e].superlative] = e));
              });
            })(o, e.irregulars),
          e.compute && Object.assign(s, e.compute),
          l && (t.hooks = l.concat(e.hooks || [])),
          e.api && e.api(n),
          e.lib && Object.keys(e.lib).forEach((t) => (r[t] = e.lib[t])),
          e.tags && r.addTags(e.tags),
          e.words && r.addWords(e.words),
          e.frozen && r.addWords(e.frozen, !0),
          e.mutate && e.mutate(t, r);
      },
      l = function (e) {
      ...
      u = function (e, t, n) {
        const { methods: r } = n;
        let a = new t([]);
        if (((a.world = n), "number" == typeof e && (e = String(e)), !e))
          return a;
        ...
        if (l(e)) {
          ...
          let n = e.map((e) =>
            e.terms.map((e) => (l(e.tags) && (e.tags = new Set(e.tags)), e))
          );
          return new t(n);
        }
        return a;
    ...
    const h = function (e, t) {
      t && h.addWords(t);
      let n = u(e, View, c);
      return e && n.compute(c.hooks), n;
    };
    Object.defineProperty(h, "_world", { value: c, writable: !0 }),
      (h.tokenize = function (e, t) {
      ...
      (h.plugin = function (e) {
        return s(e, this._world, View, this), this;
      }),
      (h.extend = h.plugin),
      (h.world = function () {
        return this._world;
    ...
    const f = (e) => /^\p{Lu}[\p{Ll}'’]/u.test(e) || /^\p{Lu}$/u.test(e),
      b = (e, t, n) => {
      ...
      w = function (e, t, n, r) {
        let [a, o, i] = t;
        0 === o || i === r[a].length ? v(n) : (v(n), v([e[t[1]]])),
          (function (e, t, n) {
            let r = e[t];
            if (0 !== t || !f(r.text)) return;
    ...
    let k = 0;
    const P = (e) =>
        (e = e.length < 3 ? "0" + e : e).length < 3 ? "0" + e : e,
      A = function (e) {
        let [t, n] = e.index || [0, 0];
        (k += 1),
          (k = k > 46655 ? 0 : k),
          (t = t > 46655 ? 0 : t),
          (n = n > 1294 ? 0 : n);
        let r = P(k.toString(36));
        r += P(t.toString(36));
        let a = n.toString(36);
        return (
          (a = a.length < 2 ? "0" + a : a),
          (r += a),
          (r += parseInt(36 * Math.random(), 10).toString(36)),
          e.normal + "|" + r.toUpperCase()
        );
      },
      C = function (e) {
      ...
      j = function (e, t, n) {
        ...
        t.forEach((s, l) => {
          ...
          0 !== d.length &&
            ((d = (function (e) {
              return e.map((e) => ((e.id = A(e)), e));
            })(d)),
            n
              ? (C(t.update([u]).firstTerm()), w(h, u, d, r))
              : (C(t.update([u]).lastTerm()),
                (function (e, t, n, r) {
                  let [a, , o] = t,
                    i = (r[a] || []).length;
                  o < i
        ...
        return (
          (t.ptrs = i),
          s.compute(["id", "index", "freeze", "lexicon"]),
    ...
    (x.append = x.insertAfter),
      (x.prepend = x.insertBefore),
      (x.insert = x.insertAfter);
    const I = /\$[0-9a-z]+/g,
      T = {},
      D = (e) => e.replace(/^\p{Ll}/u, (e) => e.toUpperCase()),
      H = (e) => e.replace(/^\p{Lu}/u, (e) => e.toLowerCase());
    (T.replaceWith = function (e, t = {}) {
      ...
      let a = r.docs[0];
      if (!a) return r;
      let o = t.possessives && a[a.length - 1].tags.has("Possessive"),
        i =
          t.case &&
          ((s = a[0].text),
          /^\p{Lu}[\p{Ll}'’]/u.test(s) || /^\p{Lu}$/u.test(s));
      var s;
      e = (function (e, t) {
      ...
      let u = (l.docs[0] || []).map((e) => Array.from(e.tags)),
        c = l.docs[0][0].pre,
        h = l.docs[0][l.docs[0].length - 1].post;
      if (
        ("string" == typeof e && (e = this.fromText(e).compute("id")),
        r.insertAfter(e),
        l.has("@hasContraction") &&
          r.contractions &&
        ...
        t.tags.has("Possessive") ||
          ((t.text += "'s"), (t.normal += "'s"), t.tags.add("Possessive"));
      }
      if ((c && r.docs[0] && (r.docs[0][0].pre = c), h && r.docs[0])) {
        let e = r.docs[0][r.docs[0].length - 1];
        e.post.trim() || (e.post = h);
      }
      let d = r.toView(n).compute(["index", "freeze", "lexicon"]);
      if (
        (d.world.compute.preTagger && d.compute("preTagger"),
        d.compute("unfreeze"),
        t.tags &&
          d.terms().forEach((e, t) => {
            e.tagSafe(u[t]);
      ...
      if (t.case) {
        let e = i ? D : H;
        d.docs[0][0].text = e(d.docs[0][0].text);
      }
      return d;
    }),
    ...
    (G.deHyphenate = G.dehyphenate), (G.toQuotation = G.toQuotations);
    var O = {
    ...
    const F = new Set([
      ...
      V = new Set(["freq", "frequency", "topk", "repeats"]),
      z = new Set(["alpha", "alphabetical"]);
    var B = {
      unique: function () {
        let e = new Set(),
          t = this.filter((t) => {
      ...
      sort: function (e) {
        ...
        return (
          F.has(e) && (e = "sequential"),
          z.has(e) && (e = "alpha"),
          V.has(e)
            ? ((a = O.byFreq(a)), this.update(a.map((e) => e.pointer)))
            : "function" == typeof O[e]
            ? ((a = a.sort(O[e])), this.update(a.map((e) => e.pointer)))
            : this
        );
      },
    };
          ...
          if ("object" == typeof e && e.isView)
            return (function (e, t) {
              ...
              return (
                ...
                (e.document = S(e.document, t.docs)),
                e.all()
              );
            })(this, e);
          if (
    ...
    const U = function (e, t, n) {
      ...
      _ = new Set(["been", "gone"]),
      X = /'/,
      Y = /(e|é|aison|sion|tion)$/,
      ee = /(age|isme|acle|ege|oire)$/;
    var te = (e, t) => ["je", e[t].normal.split(X)[1]],
      ne = (e, t) => {
        let n = e[t].normal.split(X)[1];
        return n && n.endsWith("e") ? ["la", n] : ["le", n];
      },
      re = (e, t) => {
        let n = e[t].normal.split(X)[1];
        return n && Y.test(n) && !ee.test(n)
          ? ["du", n]
          : n && n.endsWith("s")
          ? ["des", n]
          : ["de", n];
      };
    const ae = /^([0-9.]{1,4}[a-z]{0,2}) ?[-–—] ?([0-9]{1,4}[a-z]{0,2})$/i,
      oe =
      ...
      se = function (e, t) {
        let n = e[t],
          r = n.text.match(ae);
        return null !== r
          ? !0 === n.tags.has("PhoneNumber") || ie.test(n.text)
            ? null
            : [r[1], "to", r[2]]
          : ((r = n.text.match(oe)), null !== r ? [r[1], "to", r[4]] : null);
      },
      le = /^([+-]?[0-9][.,0-9]*)([a-z°²³µ/]+)$/,
      ue = function (e, t, n) {
        const r = n.model.one.numberSuffixes || {};
        let a = e[t].text.match(le);
        if (null !== a) {
      ...
      ge = {
        ...
        d: (e, t) =>
          (function (e, t) {
            let n = e[t].normal.split(R)[0];
            if (Q.has(n)) return [n, "did"];
            if (e[t + 1]) {
              if (_.has(e[t + 1].normal)) return [n, "had"];
      ...
      pe = function (e, t, n, r) {
        for (let a = 0; a < e.length; a += 1) {
          ...
          if (null !== n && n === o.before && r && r.length > 2)
      ...
      contractions: (e) => {
        ...
        n.forEach((r, i) => {
          for (let s = r.length - 1; s >= 0; s -= 1) {
            let l = null,
              u = null;
            if (!0 === ce.test(r[s].normal)) {
              let e = r[s].normal.split(ce);
              (l = e[0]), (u = e[1]);
            }
            let c = pe(o, r[s], l, u);
            !c && ge.hasOwnProperty(u) && (c = ge[u](r, s, t)),
              !c && me.hasOwnProperty(l) && (c = me[l](r, s)),
              "there" === l && "s" === u && (c = be(r, s)),
              c
                ? ((c = fe(c, e)), U(n, [i, s], c), de(n[i], e, s, c.length))
                : he.test(r[s].normal)
                ? ((c = se(r, s)),
                  c &&
                    ((c = fe(c, e)),
                    ...
                    c[2] &&
                      c[2].tags.has("Time") &&
                      a.one.setTag([c[0]], "Time", t, null, "time-range"),
                    de(n[i], e, s, c.length)))
                : ((c = ue(r, s, t)),
                  c &&
                    ((c = fe(c, e)),
                    U(n, [i, s], c),
                    a.one.setTag([c[1]], "Unit", t, null, "contraction-unit")));
          }
        });
      },
    };
    const ye = { model: q, compute: ve, hooks: ["contractions"] },
      we = function (e) {
        const t = e.world,
          { model: n, methods: r } = e.world,
          a = r.one.setTag,
          { frozenLex: o } = n.one,
          i = n.one._multiCache || {};
        e.docs.forEach((e) => {
          for (let n = 0; n < e.length; n += 1) {
            ...
            if (void 0 !== i[s] && e[n + 1])
              for (let r = n + i[s] - 1; r > n; r -= 1) {
                ...
                !0 !== o.hasOwnProperty(s) ||
                  (a(i, o[s], t, !1, "1-frozen-multi-lexicon"),
                  i.forEach((e) => (e.frozen = !0)));
              }
            void 0 !== o[s] &&
              o.hasOwnProperty(s) &&
              (a([r], o[s], t, !1, "1-freeze-lexicon"), (r.frozen = !0));
          }
        });
      },
      ke = (e) => "[34m" + e + "[0m",
    ...
    var Ce = {
      ...
      mutate: (e) => {
        ...
        (t.termMethods.isFrozen = (e) => !0 === e.frozen),
          (t.debug.freeze = Ae),
          (t.debug.frozen = Ae);
      },
      api: function (e) {
    ...
    const Ne = function (e, t, n) {
        ...
        if (void 0 !== i[u] && e[t + 1]) {
          for (let r = t + i[u] - 1; r > t; r -= 1) {
            ...
            if (!0 === s.hasOwnProperty(i)) {
              let e = s[i];
              return (
                o(a, e, n, !1, "1-multi-lexicon"),
                !e ||
                  2 !== e.length ||
                  ("PhrasalVerb" !== e[0] && "PhrasalVerb" !== e[1]) ||
                  o([a[1]], "Particle", n, !1, "1-phrasal-particle"),
                !0
              );
            }
          }
      ...
      je = /^(under|over|mis|re|un|dis|semi|pre|post)-?/,
      xe = new Set([
        "Verb",
        "Infinitive",
        "PastTense",
      ...
      Ie = function (e, t, n) {
        ...
        if (!0 === je.test(l)) {
          let e = l.replace(je, "");
          if (i.hasOwnProperty(e) && e.length > 3 && xe.has(i[e]))
          ...
          expandLexicon: function (e) {
            ...
            return (
              Object.keys(e).forEach((r) => {
                let a = e[r],
                  o = (r = (r = r.toLowerCase().trim()).replace(
                    /'s\b/,
                    ""
                  )).split(/ /);
                o.length > 1 &&
                  (void 0 === n[o[0]] || o.length > n[o[0]]) &&
                  (n[o[0]] = o.length),
                  (t[r] = t[r] || a);
              }),
              delete t[""],
      ...
      He = {
        addWords: function (e, t = !1) {
          ...
          if (
            ...
            let { lex: t, _multi: o } = r.one.expandLexicon(e, n);
            return (
              Object.assign(a.one._multiCache, o),
              void Object.assign(a.one.frozenLex, t)
            );
          }
          if (r.two.expandLexicon) {
            let { lex: t, _multi: o } = r.two.expandLexicon(e, n);
            Object.assign(a.one.lexicon, t),
              Object.assign(a.one._multiCache, o);
          }
          let { lex: o, _multi: i } = r.one.expandLexicon(e, n);
        ...
        e.forEach(function (e) {
          let a = 0,
            o = (function (e, t) {
              ...
              let a = n.one.tokenize
                .splitTerms(e, r)
                .map((e) => n.one.tokenize.splitWhitespace(e, r));
        ...
        buildTrie: function (e) {
          return (function (e) {
            return (
              ...
              (e.goNext = Ve(e.goNext, void 0)),
              (e.failTo = Ve(e.failTo, 0)),
              (e.endAs = Ve(e.endAs, null)),
              e
            );
          })(Ge(e, this.world()));
        },
        ...
        e.prototype.lookup = function (e, t = {}) {
          ...
          let r = (function (e, t, n) {
            ...
            for (let i = 0; i < a.length; i++) {
              if (e._cache && e._cache[i] && !0 === Fe(o, e._cache[i]))
                continue;
              let s = a[i],
                l = Oe(s, t, n);
    ...
    const Se = function (e, t) {
      ...
      Me = function (e, t, n) {
        ...
        return (
          ...
          "string" == typeof e &&
            ((e = r.killUnicode(e, n)), (e = r.parseMatch(e, t, n))),
          e
        );
      },
      Le = (e) => "[object Object]" === Object.prototype.toString.call(e),
      Ke = (e) => e && Le(e) && !0 === e.isView,
      Je = (e) => e && Le(e) && !0 === e.isNet;
    var We = {
        matchOne: function (e, t, n) {
          const r = this.methods.one;
          if (Ke(e)) return this.intersection(e).eq(0);
          if (Je(e)) return this.sweep(e, { tagger: !1, matchOne: !0 }).view;
          let a = { regs: (e = Me(e, n, this.world)), group: t, justOne: !0 },
            o = r.match(this.docs, a, this._cache),
            { ptrs: i, byGroup: s } = $e(o, this.fullPointer),
            l = this.toView(i);
          return (l._groups = s), l;
        },
        match: function (e, t, n) {
          const r = this.methods.one;
          if (Ke(e)) return this.intersection(e);
          if (Je(e)) return this.sweep(e, { tagger: !1 }).view.settle();
          let a = { regs: (e = Me(e, n, this.world)), group: t },
            o = r.match(this.docs, a, this._cache),
            { ptrs: i, byGroup: s } = $e(o, this.fullPointer),
            l = this.toView(i);
          return (l._groups = s), l;
        ...
        has: function (e, t, n) {
          const r = this.methods.one;
          if (Ke(e)) return this.intersection(e).fullPointer.length > 0;
          if (Je(e)) return this.sweep(e, { tagger: !1 }).view.found;
          let a = { regs: (e = Me(e, n, this.world)), group: t, justOne: !0 };
          return r.match(this.docs, a, this._cache).ptrs.length > 0;
        },
        if: function (e, t, n) {
          const r = this.methods.one;
          if (Ke(e)) return this.filter((t) => t.intersection(e).found);
          if (Je(e)) {
        ...
        splitBefore: function (e, t) {
          ...
          for (let e = 0; e < a.length; e += 1)
            !a[e].after &&
              ...
              a[e + 1].before &&
              a[e].match &&
              a[e].match[0] === a[e + 1].before[0] &&
              ((a[e].after = a[e + 1].before), delete a[e + 1].before);
          let o = [];
          return (
            a.forEach((e) => {
              o.push(e.passthrough),
    ...
    const _e = function (e, t) {
      ...
      Xe = function (e, t, n) {
        ...
        for (let t = 1; t < s.length; t += 1) {
          let n = l[l.length - 1],
            ...
            a = e.update([n]),
            u = e.update([r]);
          _e(n, r) && a.has(o) && u.has(i)
            ? (l[l.length - 1] = [n[0], n[1], r[2], n[3], r[4]])
            : l.push(r);
        }
        return e.update(l);
      },
      ...
      et = Object.assign({}, We, qe, Ze, Ye);
    (et.lookBehind = et.before),
      (et.lookBefore = et.before),
      (et.lookAhead = et.after),
      (et.lookAfter = et.after),
      (et.notIf = et.ifNo);
    const tt = /(?:^|\s)([![^]*(?:<[^<]*>)?\/.*?[^\\/]\/[?\]+*$~]*)(?:\s|$)/,
      nt = /([!~[^]*(?:<[^<]*>)?\([^)]+[^\\)]\)[?\]+*$~]*)(?:\s|$)/,
      rt = / /g,
      ...
      st = /&&/,
      lt = new RegExp(/^<\s*(\S+)\s*>/),
      ut = (e) => e.charAt(0).toUpperCase() + e.substring(1),
      ct = (e) => e.charAt(e.length - 1),
      ht = (e) => e.charAt(0),
      dt = (e) => e.substring(1),
      gt = (e) => e.substring(0, e.length - 1),
      mt = function (e) {
        return (e = dt(e)), (e = gt(e));
      },
      pt = function (e, t) {
        let n = {};
        for (let r = 0; r < 2; r += 1) {
          if (
            ("$" === ct(e) && ((n.end = !0), (e = gt(e))),
            "^" === ht(e) && ((n.start = !0), (e = dt(e))),
            "?" === ct(e) && ((n.optional = !0), (e = gt(e))),
            ("[" === ht(e) || "]" === ct(e)) &&
              ((n.group = null),
              "[" === ht(e) && (n.groupStart = !0),
              "]" === ct(e) && (n.groupEnd = !0),
          ...
          if (
            ("+" === ct(e) && ((n.greedy = !0), (e = gt(e))),
            "*" !== e &&
              "*" === ct(e) &&
              "\\*" !== e &&
              ((n.greedy = !0), (e = gt(e))),
            "!" === ht(e) && ((n.negative = !0), (e = dt(e))),
            "~" === ht(e) &&
              "~" === ct(e) &&
              e.length > 2 &&
              ((e = mt(e)),
          ...
          if (
            ...
            st.test(e)
              ? ((n.choices = e.split(st)), (n.operator = "and"))
              : ((n.choices = e.split("|")), (n.operator = "or")),
              (n.choices[0] = dt(n.choices[0]));
            let r = n.choices.length - 1;
            (n.choices[r] = gt(n.choices[r])),
              (n.choices = n.choices.map((e) => e.trim())),
              (n.choices = n.choices.filter((e) => e)),
              (n.choices = n.choices.map((e) =>
                e.split(/ /g).map((e) => pt(e, t))
              )),
              (e = "");
          }
          if ("{" === ht(e) && "}" === ct(e)) {
            if (((e = mt(e)), (n.root = e), /\//.test(e))) {
              let e = n.root.split(/\//);
              (n.root = e[0]),
                (n.pos = e[1]),
                "adj" === n.pos && (n.pos = "Adjective"),
                (n.pos =
                  n.pos.charAt(0).toUpperCase() +
                  n.pos.substr(1).toLowerCase()),
                void 0 !== e[2] && (n.sense = e[2]);
            }
            return n;
          }
          if ("<" === ht(e) && ">" === ct(e))
            return (e = mt(e)), (n.chunk = ut(e)), (n.greedy = !0), n;
          if ("%" === ht(e) && "%" === ct(e))
            return (e = mt(e)), (n.switch = e), n;
        }
        return "#" === ht(e)
          ? ((n.tag = dt(e)), (n.tag = ut(n.tag)), n)
          : "@" === ht(e)
          ? ((n.method = dt(e)), n)
          : "." === e
          ? ((n.anything = !0), n)
      ...
      Pt = function (e, t) {
        for (let n = 0; n < e.length; n += 1) {
          ...
          if (!0 !== r.optional && !0 !== r.negative && !0 !== r.fuzzy) {
            ...
            if (r.fastOr && !1 === kt(r.fastOr, t)) return !1;
          }
        }
        return !1;
      },
      ...
      jt = /^[-–—]$/,
      xt = / [-–—]{1,3} /,
      It = (e, t) => -1 !== e.post.indexOf(t),
      Tt = {
        hasQuote: (e) => Ct.test(e.pre) || Nt.test(e.post),
        hasComma: (e) => It(e, ","),
        hasPeriod: (e) => !0 === It(e, ".") && !1 === It(e, "..."),
        hasExclamation: (e) => It(e, "!"),
        hasQuestionMark: (e) => It(e, "?") || It(e, "¿"),
        hasEllipses: (e) => It(e, "..") || It(e, "…"),
        hasSemicolon: (e) => It(e, ";"),
        hasColon: (e) => It(e, ":"),
        hasSlash: (e) => /\//.test(e.text),
        hasHyphen: (e) => jt.test(e.post) || jt.test(e.pre),
        hasDash: (e) => xt.test(e.post) || xt.test(e.pre),
    ...
    Dt = function (e, t, n, r) {
      let a = (function (e, t, n, r) {
        ...
        if (void 0 !== t.method)
          return "function" == typeof Tt[t.method] && !0 === Tt[t.method](e);
        ...
        return (
          void 0 !== t.choices &&
          ("and" === t.operator
            ? t.choices.every((t) => Dt(e, t, n, r))
            : t.choices.some((t) => Dt(e, t, n, r)))
        );
      })(e, t, n, r);
    ...
    const Ht = function (e, t) {
        if (
          ...
          if (!0 === Dt(t.terms[t.t], n, t.start_i + t.t, t.phrase_length))
            return !0;
        }
        return !1;
      },
      ...
      Gt = function (e) {
        let { regs: t } = e,
          ...
          r = (function (e, t) {
            ...
            for (; n < e.terms.length; n += 1)
              if (!0 === Dt(e.terms[n], t, e.start_i + n, e.phrase_length))
                return n;
            return null;
          })(e, t[e.r + 1]);
        return null === r || 0 === r || (void 0 !== n.min && r - e.t < n.min)
          ...
          ? ((e.t = e.t + n.max), !0)
          : (!0 === e.hasGroup && (Et(e, e.t).length = r - e.t), (e.t = r), !0);
      },
      Ot = function (e, t = 0) {
        let n = e.regs[e.r],
          r = !1;
        for (let o = 0; o < n.choices.length; o += 1) {
          ...
          if (
            ((r = i.every((n, r) => {
              ...
              let i = Dt(e.terms[o], n, o + e.start_i, e.phrase_length);
              if (!0 === i && !0 === n.greedy)
                for (let t = 1; t < e.terms.length; t += 1) {
                  let r = e.terms[o + t];
                  if (r) {
                    if (!0 !== Dt(r, n, e.start_i + t, e.phrase_length)) break;
                    a += 1;
                  }
                }
              return (t += a), i;
      ...
      Ft = function (e) {
        ...
        if (r) {
          ...
          if ((!0 === e.hasGroup && (Et(e, e.t).length += r), !0 === n.end)) {
              ...
              !0 ===
                e.regs[e.r].choices.every((n) => {
                  let r = n.every((t, n) => {
                    ...
                    return (
                      void 0 !== e.terms[r] &&
                      Dt(e.terms[r], t, r, e.phrase_length)
                    );
                  });
      ...
      zt = function (e) {
        ...
        if (
          ((r.negative = !1),
          Dt(e.terms[e.t], r, e.start_i + e.t, e.phrase_length))
        )
          return !1;
        if (n.optional) {
          let n = t[e.r + 1];
          n &&
            (Dt(e.terms[e.t], n, e.start_i + e.t, e.phrase_length)
              ? (e.r += 1)
              : n.optional &&
                t[e.r + 2] &&
                Dt(
        ...
        return n.greedy
          ? (function (e, t, n) {
              ...
              for (let a = e.t; a < e.terms.length; a += 1) {
                let o = Dt(e.terms[a], t, e.start_i + e.t, e.phrase_length);
                if (o) break;
                if (
                  n &&
                  ((o = Dt(e.terms[a], n, e.start_i + e.t, e.phrase_length)), o)
                )
                  break;
        ...
        return (
          (e.t = (function (e, t) {
            ...
            for (; e.t < e.terms.length; e.t += 1) {
              if (t && Dt(e.terms[e.t], t, e.start_i + e.t, e.phrase_length))
                return e.t;
              let a = e.t - r + 1;
              if (void 0 !== n.max && a === n.max) return e.t;
              if (!1 === Dt(e.terms[e.t], n, e.start_i + e.t, e.phrase_length))
        ...
        return (
          ...
          (n.optional &&
            ...
            (function (e) {
              ...
              let n = t[e.r],
                r = e.terms[e.t],
                a = Dt(r, t[e.r + 1], e.start_i + e.t, e.phrase_length);
              if (n.negative || a) {
                let n = e.terms[e.t + 1];
                (n && Dt(n, t[e.r + 1], e.start_i + e.t, e.phrase_length)) ||
                  (e.r += 1);
              }
            })(e),
          r.implicit &&
      ...
      $t = function (e, t, n, r) {
        ...
        for (; a.r < t.length; a.r += 1) {
          ...
          if (!0 !== e.anything || !0 !== e.greedy) {
                ...
                if (!0 !== e.anything) {
                  if (!0 !== Ht(e, a)) {
                    if (e.negative) {
                      ...
                      !0 !==
                      Dt(a.terms[a.t], e, a.start_i + a.t, a.phrase_length)
                    ) {
                      if (!0 !== e.optional) return null;
                    } else if (!St(a)) return null;
                  } else if (!St(a)) return null;
                } else {
            ...
            } else if (!Ft(a)) return null;
          } else if (!Gt(a)) return null;
        }
        let o = [null, n, a.t + n];
      ...
      Lt = function (e, t, n) {
        let r = $t(e, t, 0, e.length);
        return r ? ((r = Mt(r, n)), r) : null;
      },
      Kt = {
        one: {
          termMethods: Tt,
          parseMatch: function (e, t, n) {
            ...
            let r = (function (e) {
              let t = e.split(tt),
                n = [];
              t.forEach((e) => {
                at(e) ? n.push(e) : (n = n.concat(e.split(nt)));
              }),
                (n = ot(n));
              let r = [];
              return (
                    ...
                    if (t.methods.two && t.methods.two.transform) {
                      ...
                      e.pos
                        ? "Verb" === e.pos
                          ...
                          : "Noun" === e.pos
                          ? (n = n.concat(vt(e, t)))
                          : "Adjective" === e.pos && (n = n.concat(yt(e, t)))
                        : ((n = n.concat(bt(e, t))),
                          (n = n.concat(vt(e, t))),
                          (n = n.concat(yt(e, t)))),
                        (n = n.filter((e) => e)),
              ...
              if (!n[t] || !Pt(r, n[t]))
                if (!0 !== r[0].start)
                  for (let e = 0; e < a.length; e += 1) {
                    let n = a.slice(e);
                    if (n.length < s) break;
                    let l = $t(n, r, e, a.length);
                    if (l) {
                      if (((l = Mt(l, t)), i.push(l), !0 === o)) break e;
                      let n = l.pointer[2];
                  ...
                  return (
                    (e = e.filter((e) => {
                      ...
                      for (let e = 0; e < i.length; e += 1) {
                        let n = i.slice(e);
                        if (null !== $t(n, t, e, i.length)) return !1;
                      }
                      return !0;
                    })),
                    e
    ...
    (tn.clean = tn.normal), (tn.reduced = tn.root);
    let nn = [],
      rn = 0;
    for (; rn < 64; ) nn[rn] = 0 | (4294967296 * Math.sin(++rn % Math.PI));
    const an = function (e) {
        let t,
          n,
          r,
    ...
    const ln = function (e, t) {
      ...
      un = {
        text: (e) => en(e, { keepPunct: !0 }, !1),
        normal: (e) => en(e, ln(tn.normal, { keepPunct: !0 }), !1),
        implicit: (e) => en(e, ln(tn.implicit, { keepPunct: !0 }), !1),
        machine: (e) => en(e, sn, !1),
        root: (e) => en(e, ln(sn, { form: "root" }), !1),
        hash: (e) => an(en(e, { keepPunct: !0 }, !1)),
        offset: (e) => {
          let t = un.text(e).length;
          return {
    ...
    const cn = {
      json: function (e) {
        let t =
          ...
          (r = Object.assign({}, on, r)).offset && n.compute("offset"),
          n.docs.map((e, t) => {
            let a = {};
            return (
              Object.keys(r).forEach((o) => {
                r[o] && un[o] && (a[o] = un[o](e, n, t));
              }),
              a
            );
          }));
    ...
    const hn = function (e) {
      ...
      gn = {
        debug: function (e) {
          ...
          return e && t.hasOwnProperty(e)
            ? (t[e](this), this)
            : "undefined" != typeof window && window.document
            ? (t.clientSide(this), this)
            : (t.tags(this), this);
        },
        out: function (e) {
          if (
          ...
          if ("hash" === e || "md5" === e) return an(this.text());
    ...
    var mn = {
      text: function (e) {
        ...
        var n;
        if (
          (e && "string" == typeof e && tn.hasOwnProperty(e)
            ? (t = Object.assign({}, tn[e]))
            : e &&
              ((n = e),
              "[object Object]" === Object.prototype.toString.call(n)) &&
              (t = Object.assign({}, e)),
          void 0 !== t.keepSpace || this.isFull() || (t.keepSpace = !1),
          void 0 === t.keepEndPunct && this.pointer)
        ) {
        ...
        return (
          ...
          (function (e, t) {
            ...
            for (let r = 0; r < e.length; r += 1) n += en(e[r], t, !0);
            if ((t.keepSpace || (n = n.trim()), !1 === t.keepEndPunct)) {
              e[0][0].tags.has("Emoticon") || (n = n.replace(Zt, ""));
              let t = e[e.length - 1];
              t[t.length - 1].tags.has("Emoticon") || (n = n.replace(Qt, "")),
                n.endsWith("'") &&
                  !n.endsWith("s'") &&
                  (n = n.replace(/'/, ""));
            }
    ...
    const pn = Object.assign({}, gn, mn, cn, Rt),
      fn = "[0m",
      bn = {
        green: (e) => "[32m" + e + fn,
        red: (e) => "[31m" + e + fn,
      ...
      vn = {
        tags: function (e) {
          ...
          0 === t.length && console.log(bn.blue("\n     ──────")),
            t.forEach((t) => {
              console.log(bn.blue("\n  ┌─────────")),
                t.forEach((t) => {
                  let r = [...(t.tags || [])],
                    a = t.text || "-";
                  t.sense && (a = `{${t.normal}/${t.sense}}`),
                    t.implicit && (a = "[" + t.implicit + "]"),
                    (a = bn.yellow(a));
                  let o = "'" + a + "'";
                  if (t.reference) {
        ...
        chunks: function (e) {
          ...
          console.log(""),
            t.forEach((e) => {
              ...
              e.forEach((e) => {
                "Noun" === e.chunk
                  ? t.push(bn.blue(e.implicit || e.normal))
                  : "Verb" === e.chunk
                  ? t.push(bn.green(e.implicit || e.normal))
                  : "Adjective" === e.chunk
                  ? t.push(bn.yellow(e.implicit || e.normal))
                  : "Pivot" === e.chunk
                  ? t.push(bn.red(e.implicit || e.normal))
    ...
    var yn = {
      api: function (e) {
        Object.assign(e.prototype, pn);
      },
      methods: { one: { hash: an, debug: vn } },
    };
    ...
    const Cn = function (e, t) {
      ...
      In = {
        union: function (e) {
          e = jn(e, this);
          let t = Cn(this.fullPointer, e.fullPointer);
          return (t = xn(t, this.document)), this.toView(t);
        },
      };
    (In.and = In.union),
      (In.intersection = function (e) {
        e = jn(e, this);
        let t = (function (e, t) {
          let n = kn(t),
            r = [];
      ...
      (In.not = function (e) {
        e = jn(e, this);
        let t = Nn(this.fullPointer, e.fullPointer);
        return (t = xn(t, this.document)), this.toView(t);
      }),
      (In.difference = In.not),
      (In.complement = function () {
        let e = this.all(),
          t = Nn(e.fullPointer, this.fullPointer);
        return (t = xn(t, this.document)), this.toView(t);
      }),
      (In.settle = function () {
        let e = this.fullPointer;
        ...
        buildNet: function (e, t) {
          ...
          e.forEach((e) => {
            ...
            Object.keys(n).forEach((e) => {
              let t = {};
              n[e] = n[e].filter(
                (e) => "boolean" != typeof t[e.match] && ((t[e.match] = !0), !0)
              );
            });
            ...
            o = (function (e, t) {
              return e.map((n, r) => {
                ...
                return (
                  (a = a.filter(
                    (e) =>
                      "boolean" != typeof o[e.match] && ((o[e.match] = !0), !0)
                  )),
                  a
                );
              });
          ...
          (o = (function (e, t) {
            return e.map((e, n) => {
              ...
              return (e = (e = e.filter((e) =>
                ...
                (e) => void 0 === e.ifNo || !0 !== e.ifNo.some((e) => r.has(e))
              )).filter(
                (e) =>
                  0 === e.wants.length ||
          ...
          return 0 === e.length
            ...
            : (("undefined" != typeof process && process.env
              ...
              e.map((e) => {
                ...
                void 0 !== e.unTag && s(u, e.unTag, n, e.safe, a),
    ...
    const On = / /,
        ...
        if (a) {
          ...
          if (a.parents && a.parents.length > 0)
            for (let t = 0; t < a.parents.length; t += 1)
              e.tags.add(a.parents[t]), Fn(e, a.parents[t]);
        }
        return e.tags.add(t), (e.dirty = !0), Fn(e, t), !0;
      },
      zn = function (e, t, n = {}, r, a) {
        ...
        if (
          ...
          if ("string" == typeof t)
            if (((t = t.trim()), On.test(t)))
              !(function (e, t, n, r) {
                let a = t.split(On);
                e.forEach((e, t) => {
                  let o = a[t];
                  o && ((o = o.replace(/^#/, "")), Vn(e, o, n, r));
                });
              })(e, t, o, r);
            else {
              t = t.replace(/^#/, "");
              for (let n = 0; n < e.length; n += 1) Vn(e[n], t, o, r);
            }
          else console.warn(`compromise: Invalid tag '${t}'`);
        else t.forEach((t) => zn(e, t, n, r));
      },
      Bn = function (e) {
        return (
      ...
      Ln = (e) => "[object Array]" === Object.prototype.toString.call(e),
      Kn = (e) => (e = e || "").trim(),
      Jn = function (e = []) {
        return "string" == typeof e
          ? (function (e) {
      ...
      Un = { text: Wn, txt: Wn, array: qn, flat: qn },
      Rn = function (e, t) {
        return "nested" === t || "json" === t
          ? e
          : "debug" === t
          ? (console.log(Wn(e, !0)), null)
          : Un.hasOwnProperty(t)
          ? Un[t](e)
          : e;
      },
    ...
    let _n = class g {
      ...
      add(e, t = {}) {
        if (Ln(e)) return e.forEach((e) => this.add(Kn(e), t)), this;
        e = Kn(e);
        let n = Bn({ id: e, props: t });
      ...
      out(e) {
        return Qn(this.json), Rn(this.json, e);
      }
      debug() {
        return Qn(this.json), Rn(this.json, "debug"), this;
      }
    };
    const Xn = function (e) {
      let t = Jn(e);
    ...
    Xn.prototype.plugin = function (e) {
      e(this);
    };
    const Yn = {
        Noun: "blue",
      ...
      er = function (e) {
        if (Yn.hasOwnProperty(e.id)) return Yn[e.id];
        if (Yn.hasOwnProperty(e.is)) return Yn[e.is];
        let t = e._cache.parents.find((e) => Yn[e]);
        return Yn[t];
      },
      tr = function (e) {
      ...
      nr = function (e, t) {
        return (
          ...
          Object.keys(e).forEach((t) => {
            (e[t].children = tr(e[t].children)), (e[t].not = tr(e[t].not));
          }),
          Object.keys(e).forEach((t) => {
            (e[t].not || []).forEach((n) => {
      ...
      one: {
        ...
        addTags: function (e, t) {
          ...
          const n = (function (e) {
              ...
              return Xn(t).cache().fillDown().out("array");
            })(Object.assign({}, t, e)),
            r = (function (e) {
              const t = {};
              return (
        ...
        canBe: function (e, t, n) {
          if (!n.hasOwnProperty(t)) return !0;
          let r = n[t].not || [];
          for (let t = 0; t < r.length; t += 1) if (e.tags.has(r[t])) return !1;
          return !0;
        },
      },
    };
    ...
    const sr = new Set(["Auxiliary", "Possessive"]);
    var lr = {
      model: { one: { tagSet: {} } },
      compute: {
        tagRank: function (e) {
          ...
          t.forEach((e) => {
            e.forEach((e) => {
              ...
              e.tagRank = (function (e, t) {
                return (
                  (e = e.sort((e, n) => {
                    if (sr.has(e) || !t.hasOwnProperty(n)) return 1;
                    if (sr.has(n) || !t.hasOwnProperty(e)) return -1;
                    let r = t[e].children || [],
                      a = r.length;
    ...
    const ur = /([.!?\u203D\u2E18\u203C\u2047-\u2049\u3002]+\s)/g,
      ...
      pr = RegExp("[" + Object.keys(mr).join("") + "]", "g"),
      fr = RegExp("[" + Object.values(mr).join("") + "]", "g"),
      br = function (e) {
        if (!e) return !1;
        let t = e.match(fr);
    ...
    Ir = Ir.reduce((e, t) => ((e[t] = !0), e), {});
    const Tr = /\p{Letter}/u,
      Dr = /[\p{Number}\p{Currency_Symbol}]/u,
      Hr = /^[a-z]\.([a-z]\.)+/i,
      Er = /[sn]['’]$/,
      Gr = /([A-Z]\.)+[A-Z]?,?$/,
      Or = /^[A-Z]\.,?$/,
      ...
      one: {
        ...
        tokenize: {
          splitSentences: function (e, t) {
            if (
              ((e = e || ""),
              !(e = String(e)) || "string" != typeof e || !1 === wr.test(e))
            )
              return [];
            let n = (function (e) {
                let t = [],
            ...
            for (let e = 1; e < r.length; e += 1) {
              let t = r[e].match(kr);
              null !== t && ((r[e - 1] += t[0]), (r[e] = r[e].replace(kr, "")));
            }
            return r;
          },
          isSentence: function (e, t) {
            if (!1 === Mr.test(e)) return !1;
            if (!0 === Sr.test(e)) return !1;
            if (3 === e.length && Kr.test(e)) return !1;
            if (!0 === $r.test(e)) return !1;
            let n = e
                .replace(/[.!?\u203D\u2E18\u203C\u2047-\u2049] *$/, "")
                .split(" "),
              r = n[n.length - 1].toLowerCase();
            return !0 !== t.hasOwnProperty(r) || !0 !== Lr.test(e);
          },
          splitTerms: function (e, t) {
            ...
            for (let e = 0; e < a.length; e++)
              !0 !== Pr(a[e], t) ? r.push(a[e]) : (r = r.concat(Ar(a[e])));
            let o = "";
            for (let e = 0; e < r.length; e++) {
              let t = r[e];
              !0 === Nr.test(t) &&
              !1 === Ir.hasOwnProperty(t) &&
              !1 === jr.test(t)
                ? (n.length > 0
          ...
          splitWhitespace: (e, t) => {
            let {
              ...
              for (let e = 0; e < u; e += 1) {
                let e = l[0];
                if (!0 !== n[e]) {
                  if (("+" === e || "-" === e) && Dr.test(l[1])) break;
                  if ("'" === e && 3 === e.length && Dr.test(l[1])) break;
                  if (Tr.test(e) || Dr.test(e)) break;
                  i += l.shift();
                }
              }
              u = l.length;
            ...
            return { text: n, pre: r, post: a, tags: new Set() };
          },
    ...
    const Zr = /\//,
      ...
      Yr = function (e, t) {
        ...
        if (
          (r.hasOwnProperty(n) &&
            ((e.alias = e.alias || []), e.alias.push(r[n])),
          Zr.test(n) && !_r.test(n) && !Xr.test(n))
        ) {
          let t = n.split(Zr);
          t.length <= 3 &&
            t.forEach((t) => {
    ...
    var ca = {
      ...
      ha = {
        ...
        PastTense:
          "true¦began,came,d4had,kneel3l2m0sa4we1;ea0sg2;nt;eap0i0;ed;id",
        Participle:
    ...
    const da = 36,
      ...
      ma = ga.split("").reduce(function (e, t, n) {
        return (e[t] = n), e;
      }, {});
    var pa = function (e) {
      if (void 0 !== ma[e]) return ma[e];
      let t = 0,
        n = 1,
        r = da,
        a = 1;
      for (; n < e.length; t += r, n++, r *= da);
      for (let n = e.length - 1; n >= 0; n--, a *= da) {
        let r = e.charCodeAt(n) - 48;
        r > 10 && (r -= 7), (t += r * a);
      }
      return t;
    };
    const fa = function (e, t, n) {
        const r = pa(t);
      ...
      ka = function (e = "", t) {
        ...
        let a = (function (e) {
          let t = e[e.length - 1];
          if (!0 === ya.hasOwnProperty(t))
            for (let n = 0; n < ya[t].length; n += 1) {
              let r = ya[t][n][0];
              if (!0 === r.test(e)) return e.replace(r, ya[t][n][1]);
            }
          return null;
        })(e);
        return null !== a ? a : wa.test(e) ? e + "es" : e + "s";
      },
      Pa = /\|/;
    let Aa = {
      ...
      Ca = {};
    const Na = { two: { irregularPlurals: ca, uncountable: {} } };
    ...
    const Ia = "Infinitive";
    var Ta = {
      beforeTags: { Modal: Ia, Adverb: Ia, Negative: Ia, Plural: Ia },
      afterTags: {
        Determiner: Ia,
        Adverb: Ia,
        Possessive: Ia,
    ...
    const Da = {
        beforeTags: Object.assign({}, Ta.beforeTags, xa.beforeTags, {}),
        afterTags: Object.assign({}, Ta.afterTags, xa.afterTags, {}),
        beforeWords: Object.assign({}, Ta.beforeWords, xa.beforeWords, {}),
        afterWords: Object.assign({}, Ta.afterWords, xa.afterWords, {}),
      },
      Ha = "Adjective";
    var Ea = {
      beforeTags: { Determiner: Ha, Possessive: Ha, Hyphenated: Ha },
      afterTags: { Adjective: Ha },
      beforeWords: {
        seem: Ha,
        seemed: Ha,
        seems: Ha,
      ...
      afterWords: { too: Ha, also: Ha, or: Ha, enough: Ha, as: Ha },
    };
    const Ga = "Gerund";
    var Oa = {
      beforeTags: { Adverb: Ga, Preposition: Ga, Conjunction: Ga },
      afterTags: {
        Adverb: Ga,
        Possessive: Ga,
        Person: Ga,
    ...
    const Fa = "Gerund",
      Va = "Adjective",
      za = {
        beforeTags: Object.assign({}, Ea.beforeTags, Oa.beforeTags, {
          Imperative: Fa,
          Infinitive: Va,
          Plural: Fa,
        }),
        afterTags: Object.assign({}, Ea.afterTags, Oa.afterTags, { Noun: Va }),
        beforeWords: Object.assign({}, Ea.beforeWords, Oa.beforeWords, {
          is: Va,
          are: Fa,
          was: Va,
          of: Va,
        ...
        afterWords: Object.assign({}, Ea.afterWords, Oa.afterWords, {
          to: Fa,
          not: Fa,
          the: Fa,
        }),
      ...
      Sa = {
        ...
        afterTags: Object.assign({}, Ea.afterTags, xa.afterTags, Ba.afterTags),
        beforeWords: Object.assign({}, Ea.beforeWords, xa.beforeWords, {
          are: "Adjective",
          is: "Adjective",
          was: "Adjective",
          be: "Adjective",
        ...
        afterWords: Object.assign({}, Ea.afterWords, xa.afterWords),
      };
    let $a = "PastTense",
      Ma = "Adjective";
    const La = {
    ...
    var Ka = {
      beforeTags: Object.assign({}, Ea.beforeTags, La.beforeTags),
      afterTags: Object.assign({}, Ea.afterTags, La.afterTags),
      beforeWords: Object.assign({}, Ea.beforeWords, La.beforeWords),
      afterWords: Object.assign({}, Ea.afterWords, La.afterWords),
    };
    const Ja = { afterTags: { Noun: "Adjective", Conjunction: void 0 } },
      Wa = {
        beforeTags: Object.assign({}, Ea.beforeTags, Ta.beforeTags, {
          Adverb: void 0,
          Negative: void 0,
        }),
        afterTags: Object.assign({}, Ea.afterTags, Ta.afterTags, Ja.afterTags),
        beforeWords: Object.assign({}, Ea.beforeWords, Ta.beforeWords, {
          have: void 0,
          had: void 0,
          not: void 0,
          went: "Adjective",
        ...
        afterWords: Object.assign({}, Ea.afterWords, Ta.afterWords, {
          to: void 0,
          as: "Adjective",
        }),
      },
      ...
      Za = {
        beforeTags: Object.assign({}, Oa.beforeTags, xa.beforeTags, qa),
        afterTags: Object.assign({}, Oa.afterTags, xa.afterTags, Ua),
        beforeWords: Object.assign({}, Oa.beforeWords, xa.beforeWords, Ra),
        afterWords: Object.assign({}, Oa.afterWords, xa.afterWords, Qa),
      },
      _a = "Singular",
      Xa = "Infinitive",
      Ya = {
      ...
      eo = "Person";
    var to = {
      beforeTags: { Honorific: eo, Person: eo },
      afterTags: { Person: eo, ProperNoun: eo, Verb: eo },
      ownTags: { ProperNoun: eo },
      beforeWords: { hi: eo, hey: eo, yo: eo, dear: eo, hello: eo },
      afterWords: {
        said: eo,
        says: eo,
        told: eo,
    ...
    const no = "Month",
      ro = {
        beforeTags: { Date: no, Value: no },
        afterTags: { Date: no, Value: no },
        beforeWords: {
          by: no,
          in: no,
          on: no,
        ...
        afterWords: { sometime: no, in: no, of: no, until: no, the: no },
      };
    var ao = {
      beforeTags: Object.assign({}, to.beforeTags, ro.beforeTags),
      afterTags: Object.assign({}, to.afterTags, ro.afterTags),
      beforeWords: Object.assign({}, to.beforeWords, ro.beforeWords),
      afterWords: Object.assign({}, to.afterWords, ro.afterWords),
    };
    const oo = "Place",
      io = {
        beforeTags: { Place: oo },
        afterTags: { Place: oo, Abbreviation: oo },
        beforeWords: { in: oo, by: oo, near: oo, from: oo, to: oo },
        afterWords: {
          in: oo,
          by: oo,
          near: oo,
    ...
    const lo = {
        ...
        "Noun|Gerund": Za,
        "Person|Noun": {
          beforeTags: Object.assign({}, xa.beforeTags, to.beforeTags),
          afterTags: Object.assign({}, xa.afterTags, to.afterTags),
          beforeWords: Object.assign({}, xa.beforeWords, to.beforeWords, {
            i: "Infinitive",
            we: "Infinitive",
          }),
          afterWords: Object.assign({}, xa.afterWords, to.afterWords),
        },
        "Person|Date": ao,
        "Person|Verb": {
          beforeTags: Object.assign(
        ...
        "Person|Place": {
          beforeTags: Object.assign({}, io.beforeTags, to.beforeTags),
          afterTags: Object.assign({}, io.afterTags, to.afterTags),
          beforeWords: Object.assign({}, io.beforeWords, to.beforeWords),
          afterWords: Object.assign({}, io.afterWords, to.afterWords),
        },
        "Person|Adj": {
          beforeTags: Object.assign({}, to.beforeTags, Ea.beforeTags),
          afterTags: Object.assign({}, to.afterTags, Ea.afterTags),
          beforeWords: Object.assign({}, to.beforeWords, Ea.beforeWords),
          afterWords: Object.assign({}, to.afterWords, Ea.afterWords),
        },
        "Unit|Noun": {
          beforeTags: { Value: so },
          afterTags: {},
          ...
          afterWords: { per: so, squared: so, cubed: so, long: so },
        },
      },
      uo = (e, t) => {
    ...
    lo["Plural|Verb"] = {
      beforeWords: uo(lo["Noun|Verb"].beforeWords, {
        had: "Plural",
        have: "Plural",
      }),
      afterWords: uo(lo["Noun|Verb"].afterWords, {
        his: "PresentTense",
        her: "PresentTense",
        its: "PresentTense",
        in: null,
      ...
      beforeTags: uo(lo["Noun|Verb"].beforeTags, {
        Conjunction: "PresentTense",
        Noun: void 0,
        ProperNoun: "PresentTense",
      }),
      afterTags: uo(lo["Noun|Verb"].afterTags, {
        Gerund: "Plural",
        Noun: "PresentTense",
        Value: "PresentTense",
      }),
    ...
    var No = [
      null,
      null,
      { ea: mo, ia: wo, ic: co, ly: fo, "'n": yo, "'t": yo },
      {
        oed: po,
        ued: po,
        xed: po,
      ...
      { chester: Ao, logists: vo, opoulos: ko, borough: Ao, sdottir: ko },
    ];
    const jo = "Adjective",
      xo = "Noun",
      Io = "Verb";
    var To = [
      ...
      null,
      {},
      { neo: xo, bio: xo, "de-": Io, "re-": Io, "un-": Io, "ex-": xo },
      {
        anti: xo,
        auto: xo,
        faux: jo,
    ...
    var Mo = {
      a: [
        [/.[aeiou]na$/, So, "tuna"],
        [/.[oau][wvl]ska$/, $o],
        [/.[^aeiou]ica$/, Go, "harmonica"],
        [/^([hyj]a+)+$/, Vo, "haha"],
      ],
      c: [[/.[^aeiou]ic$/, Do]],
      d: [
        [/[aeiou](pp|ll|ss|ff|gg|tt|rr|bb|nn|mm)ed$/, Oo, "popped"],
        [/.[aeo]{2}[bdgmnprvz]ed$/, Oo, "rammed"],
        [/.[aeiou][sg]hed$/, Oo, "gushed"],
        [/.[aeiou]red$/, Oo, "hired"],
        [/.[aeiou]r?ried$/, Oo, "hurried"],
        [/[^aeiou]ard$/, Go, "steward"],
        [/[aeiou][^aeiou]id$/, Do, ""],
        [/.[vrl]id$/, Do, "livid"],
        [/..led$/, Oo, "hurled"],
        [/.[iao]sed$/, Oo, ""],
        [/[aeiou]n?[cs]ed$/, Oo, ""],
        [/[aeiou][rl]?[mnf]ed$/, Oo, ""],
        [/[aeiou][ns]?c?ked$/, Oo, "bunked"],
        [/[aeiou]gned$/, Oo],
        [/[aeiou][nl]?ged$/, Oo],
        [/.[tdbwxyz]ed$/, Oo],
        [/[^aeiou][aeiou][tvx]ed$/, Oo],
        [/.[cdflmnprstv]ied$/, Oo, "emptied"],
      ],
      e: [
        [/.[lnr]ize$/, Ho, "antagonize"],
        [/.[^aeiou]ise$/, Ho, "antagonise"],
        [/.[aeiou]te$/, Ho, "bite"],
        [/.[^aeiou][ai]ble$/, Do, "fixable"],
        [/.[^aeiou]eable$/, Do, "maleable"],
        [/.[ts]ive$/, Do, "festive"],
        [/[a-z]-like$/, Do, "woman-like"],
      ],
      h: [
        [/.[^aeiouf]ish$/, Do, "cornish"],
        [/.v[iy]ch$/, $o, "..ovich"],
        [/^ug?h+$/, Vo, "ughh"],
        [/^uh[ -]?oh$/, Vo, "uhoh"],
        [/[a-z]-ish$/, Do, "cartoon-ish"],
      ],
      i: [[/.[oau][wvl]ski$/, $o, "polish-male"]],
      k: [[/^(k){2}$/, Vo, "kkkk"]],
      l: [
        [/.[gl]ial$/, Do, "familial"],
        [/.[^aeiou]ful$/, Do, "fitful"],
        [/.[nrtumcd]al$/, Do, "natal"],
        [/.[^aeiou][ei]al$/, Do, "familial"],
      ],
      m: [
        [/.[^aeiou]ium$/, Go, "magnesium"],
        [/[^aeiou]ism$/, Go, "schism"],
        [/^[hu]m+$/, Vo, "hmm"],
        [/^\d+ ?[ap]m$/, "Date", "3am"],
      ],
      n: [
        [/.[lsrnpb]ian$/, Do, "republican"],
        [/[^aeiou]ician$/, zo, "musician"],
    ...
    const _o = function (e = "", t = {}) {
      ...
      ti = function (e) {
        ...
        return Object.keys(t).reduce(
          (e, n) => (
            (e[n] = (function (e = "", t = "") {
              let n = (t = String(t)).match(ei);
              if (null === n) return t;
              let r = Number(n[1]) || 0;
              return e.substring(0, r) + t.replace(ei, "");
            })(n, t[n])),
            e
          ),
          {}
    ...
    var gi = {
        ...
        toComparative: hi,
        toSuperlative: di,
        fromComparative: Yo(hi),
        fromSuperlative: Yo(di),
        adjToNoun: ni(Zo),
      },
      mi = [
        "academy",
    ...
    const bi = function (e, t) {
      ...
      for (let t = 0; t < fi.length; t++)
        if (!0 === fi[t][0].test(e)) return (e = e.replace(fi[t][0], fi[t][1]));
      return e;
    };
    var vi = {
      toPlural: ka,
    ...
    yi = Object.keys(yi).reduce(
      (e, t) => (yi[t].forEach((n) => (e[n] = t)), e),
      {}
    );
    const wi = function (e) {
        let t = e.substring(e.length - 3);
        if (!0 === yi.hasOwnProperty(t)) return yi[t];
        let n = e.substring(e.length - 2);
        return !0 === yi.hasOwnProperty(n)
          ? yi[n]
      ...
      Pi = function (e, t, n) {
        ...
        let {
          ...
          c = "";
        if ((n || (n = wi(e)), ki.hasOwnProperty(e))) c = ki[e];
        else if ("Participle" === n) c = _o(l, i);
        else if ("PastTense" === n) c = _o(l, r);
        else if ("PresentTense" === n) c = _o(l, a);
        else {
      ...
      Ai = function (e, t) {
        ...
        if (u !== e && u !== l.PastTense) {
          let n = t.one.lexicon || {};
          ("Participle" !== n[u] && "Adjective" !== n[u]) ||
            ("play" === e && (u = "played"), (l.Participle = u));
        }
        return (
          s &&
    ...
    var Vi = {
      ...
      zi = { noun: vi, verb: Ci, adjective: Vi },
      Bi = {
        Singular: (e, t, n, r) => {
          let a = r.one.lexicon,
    ...
    const Si = {
      ...
      $i = new Set(["israelis", "menus", "logos"]),
      Mi = [
        "bus",
        "mas",
        "was",
      ...
      Li = function (e) {
        ...
        if ($i.has(e)) return !0;
        let t = e[e.length - 1];
        return Si.hasOwnProperty(t)
          ? Si[t].find((t) => e.endsWith(t))
                ...
                t.test(a.post) &&
                  (function (e, t) {
                    ...
                    if (e[t - 1]) {
                      ...
                      if (n.tags.has("Adjective") || r.tags.has("Adjective"))
                        return !1;
                    }
                    let o = r.normal;
                    return (
        ...
        expandLexicon: function (e, t) {
          ...
          return (
            Object.keys(e).forEach((t) => {
              ...
              s.length > 1 &&
                (void 0 === o[s[0]] || s.length > o[s[0]]) &&
                (o[s[0]] = s.length),
                !0 === Bi.hasOwnProperty(i) && Bi[i](t, a, n, r),
                (a[t] = a[t] || i);
            }),
            delete a[""],
            delete a.null,
    ...
    let Ji = { one: { lexicon: {} }, two: { models: gi } };
    const Wi = {
        "Actor|Verb": "Actor",
      ...
      qi = function (e, t) {
        const n = { model: t, methods: Ki };
        let { lex: r, _multi: a } = Ki.two.expandLexicon(e, n);
        return (
          ...
          Object.keys(e).forEach((a) => {
            ...
            if (
              ...
              ("Noun|Verb" !== o &&
                ...
                "Actor|Verb" !== o) ||
                Ui(a, r, !1),
              "Adj|Present" === o && (Ui(a, r, !0), Ri(a, r, t)),
              "Person|Adj" === o && Ri(a, r, t),
              "Adj|Gerund" === o || "Noun|Gerund" === o)
            ) {
              let e = Pi(a, Ji, "Gerund");
              r[e] || (n[e] = "Infinitive");
            }
            if (
              (("Noun|Gerund" !== o &&
        ...
        (e = (function (e) {
          ...
          return (
            Object.entries(t).forEach((e) => {
              (n[e[0]] = n[e[0]] || "Singular"),
                (n[e[1]] = n[e[1]] || "Plural");
            }),
            e
          );
        })((e = Qi(e.two.switches, e)))),
        e
      );
    })(Zi);
    const _i = function (e, t, n, r) {
        ...
        "-" === e[t].post &&
          e[t + 1] &&
          a([e[t], e[t + 1]], "Hyphenated", r, null, "1-punct-hyphen''");
      },
      ...
      Yi = function (e, t, n) {
        ...
        else if (Xi.test(a.normal)) {
          let e = a.normal.replace(Xi, "");
      ...
      ns = function (e, t, n) {
        ...
        for (let e = 0; e < a.length; e += 1)
          if (n.one.tagSet[a[e]]) {
            ...
            es(r, t, ` -inferred by #${a[e]}`);
          }
        !(function (e) {
          !e.tags.has("Noun") ||
            e.tags.has("Plural") ||
            e.tags.has("Singular") ||
            ts.find((t) => e.tags.has(t)) ||
            (Li(e.normal)
              ? es(e, "Plural", "3-plural-guess")
              : es(e, "Singular", "3-singular-guess"));
        })(r),
          (function (e) {
            let t = e.tags;
            if (t.has("Verb") && 1 === t.size) {
              let t = wi(e.normal);
              t && es(e, t, "3-verb-tense-guess");
            }
          })(r);
      },
      rs = /^\p{Lu}[\p{Ll}'’]/u,
      as = /[0-9]/,
      os = ["Date", "Month", "WeekDay", "Unit", "Expression"],
      is = /[IVX]/,
      ss = /^[IVXLCDM]{2,}$/,
      ls = /^M{0,4}(CM|CD|D?C{0,3})(XC|XL|L?X{0,3})(IX|IV|V?I{0,3})$/,
      us = { li: !0, dc: !0, md: !0, dm: !0, ml: !0 },
      cs = function (e, t, n) {
        let r = e[t];
        r.index = r.index || [0, 0];
        let a = r.index[1],
          o = r.text || "";
        return 0 !== a && !0 === rs.test(o) && !1 === as.test(o)
          ? os.find((e) => r.tags.has(e)) ||
            r.pre.match(/["']$/) ||
            "the" === r.normal
            ? null
            : (ns(e, t, n),
              r.tags.has("Noun") || r.frozen || r.tags.clear(),
              es(r, "ProperNoun", "2-titlecase"),
              !0)
          : o.length >= 2 &&
            ss.test(o) &&
            is.test(o) &&
      ...
      ds = function (e, t, n) {
        let r = e[t];
        if (0 === r.tags.size) {
          let e = hs(r.normal, n.two.suffixPatterns);
          if (null !== e) return es(r, e, "2-suffix"), (r.confidence = 0.7), !0;
          if (
            r.implicit &&
            ((e = hs(r.implicit, n.two.suffixPatterns)), null !== e)
          )
            return es(r, e, "2-implicit-suffix"), (r.confidence = 0.7), !0;
        }
        return null;
      },
      gs = /['‘’‛‵′`´]/,
      ...
      ps = function (e, t, n, r) {
        ...
        let {
          ...
          h = u.text;
        gs.test(u.post) && !gs.test(u.pre) && (h += u.post.trim());
        let d = ms(h, o) || ms(c, i);
        return (
          !d && /[0-9]/.test(c) && (d = ms(c, s)),
          d ||
            0 !== u.tags.size ||
            (d = (function (e = "", t) {
              let n = e[e.length - 1];
      ...
      fs = function (e, t, n) {
        ...
        if (0 === r.tags.size) {
          ...
          if (null !== e) return es(r, e, "2-prefix"), (r.confidence = 0.5), !0;
        }
        return null;
      },
      bs = new Set([
      ...
      ks = function (e, t) {
        ...
        if (
          ...
          if (r && !isNaN(r) && r > 1400 && r < 2100) {
            let a = e[t - 1],
              o = e[t + 1];
            if (vs(a) || vs(o)) return es(n, "Year", "2-tagYear");
            if (r >= 1920 && r < 2025) {
              if (ys(a) || ys(o)) return es(n, "Year", "2-tagYear-close");
              if (ws(e[t - 2]) || ws(e[t + 2]))
                return es(n, "Year", "2-tagYear-far");
              if (
                a &&
                ...
                return es(n, "Year", "2-tagYear-noun");
            }
          }
        }
        return null;
      ...
      Ps = function (e, t, n, r) {
        ...
        o.tags.has("Verb") &&
          (i.find((e) => o.tags.has(e)) ||
            a([o], "Infinitive", r, null, "2-verb-type''"));
      },
      As = /^[A-Z]('s|,)?$/,
      Cs = /^[A-Z-]+$/,
      Ns = /^[A-Z]+s$/,
      ...
      Is = /([a-z]\.)+[a-z]\.?$/,
      Ts = { I: !0, A: !0 },
      Ds = { la: !0, ny: !0, us: !0, dc: !0, gb: !0 },
      Hs = function (e, t, n) {
        let r = e[t];
        return r.tags.has("RomanNumeral") || r.tags.has("Acronym") || r.frozen
          ? null
          : (function (e, t) {
              let n = e.text;
              if (!1 === Cs.test(n)) {
                if (!(n.length > 3 && !0 === Ns.test(n))) return !1;
                n = n.replace(/s$/, "");
              }
              return !(
                n.length > 5 ||
          ...
          ? (r.tags.clear(),
            es(r, ["Acronym", "Noun"], "3-no-period-acronym"),
            !0 === Ds[r.normal] && es(r, "Place", "3-place-acronym"),
            !0 === Ns.test(r.text) && es(r, "Plural", "3-plural-acronym"),
            !0)
          : !Ts.hasOwnProperty(r.text) && As.test(r.text)
          ? (r.tags.clear(),
            es(r, ["Acronym", "Noun"], "3-one-letter-acronym"),
            !0)
          : r.tags.has("Organization") && r.text.length <= 3
          ? (es(r, "Acronym", "3-org-acronym"), !0)
          : r.tags.has("Organization") && Cs.test(r.text) && r.text.length <= 6
          ? (es(r, "Acronym", "3-titlecase-acronym"), !0)
          : null;
      },
      Es = function (e, t) {
        if (!e) return null;
      ...
      Vs = function (e, t, n, r) {
        ...
        let i = e[t];
        if (!0 === a[i.machine || i.normal] && Fs(e[t - 1], t - 1, r)) {
          o([e[t]], "Organization", n, null, "3-[org-word]");
          for (let a = t; a >= 0 && Fs(e[a], a, r); a -= 1)
            o([e[a]], "Organization", n, null, "3-[org-word]");
        }
        return null;
      },
      zs = /'s$/,
      ...
      Ms = function (e, t, n, r) {
        ...
        if (!0 === a[s]) {
          for (let a = t - 1; a >= 0; a -= 1)
            if (!Bs.has(e[a].normal)) {
              if (!$s(e[a], a, r)) break;
              o(e.slice(a, t + 1), "Place", n, null, "3-[place-of-foo]");
            }
          if (Ss.has(s)) return !1;
          for (let a = t + 1; a < e.length; a += 1) {
            if ($s(e[a], a, r))
              return (
                o(e.slice(t, a + 1), "Place", n, null, "3-[foo-place]"), !0
              );
            if ("of" !== e[a].normal && !Bs.has(e[a].normal)) break;
          }
        }
        return null;
      },
      Ls = function (e, t, n) {
        ...
        (0 === a.size ||
          ...
          (r = !0),
          r &&
            (es(e[t], "Noun", "3-[fallback]"),
            ns(e, t, n),
            (e[t].confidence = 0.1));
      },
      Ks = /^[A-Z][a-z]/,
      Js = (e, t) =>
        e[t].tags.has("ProperNoun") && Ks.test(e[t].text) ? "Noun" : null,
      Ws = (e, t, n) => (0 !== t || e[1] ? null : n),
      qs = {
        "Adj|Gerund": (e, t) => Js(e, t),
        "Adj|Noun": (e, t) =>
          Js(e, t) ||
          (function (e, t) {
        ...
        "Actor|Verb": (e, t) => Js(e, t),
        "Adj|Past": (e, t) => Js(e, t),
        "Adj|Present": (e, t) => Js(e, t),
        "Noun|Gerund": (e, t) => Js(e, t),
        "Noun|Verb": (e, t) => (t > 0 && Js(e, t)) || Ws(e, t, "Infinitive"),
        "Plural|Verb": (e, t) =>
          Js(e, t) ||
          Ws(e, t, "PresentTense") ||
          (function (e, t, n) {
        ...
        "Person|Noun": (e, t) => Js(e, t),
        "Person|Verb": (e, t) => (0 !== t ? Js(e, t) : null),
        "Person|Adj": (e, t) =>
          (0 === t && e.length > 1) || Js(e, t) ? "Person" : null,
      },
      Us =
        "undefined" != typeof process && process.env
          ? process.env
          : self.env || {},
      Rs = /^(under|over|mis|re|un|dis|semi)-?/,
      Qs = (e, t) => {
        if (!e || !t) return null;
      ...
      Zs = (e, t = {}, n) => {
        if (!e || !t) return null;
        let r = Array.from(e.tags).sort((e, t) =>
        ...
        return (
          a &&
            Us.DEBUG_TAGS &&
            console.log(`  [2m[3m      ↓ - '${e.normal || e.implicit}' (#${a})  [0m`),
          (a = t[a]),
          a
        );
      },
        ...
        if ((Rs.test(l) && !o[l] && (l = l.replace(Rs, "")), s.switch)) {
          ...
          let u = (function (e, t, n, r) {
            ...
            const a = "also" !== e[t - 1]?.text ? t - 1 : Math.max(0, t - 2),
              o = r.one.tagSet;
            let i = Qs(e[t + 1], n.afterWords);
            return (
              (i = i || Qs(e[a], n.beforeWords)),
              (i = i || Zs(e[a], n.beforeTags, o)),
              (i = i || Zs(e[t + 1], n.afterTags, o)),
              i
            );
          })(e, t, i[o], r);
          qs[o] && (u = qs[o](e, t) || u),
            u
              ? (a([s], u, n, null, `3-[switch] (${o})`), ns(e, t, r))
              : Us.DEBUG_TAGS && console.log(`\n -> X  - '${l}'  : (${o})  `);
        }
      },
      Xs = { there: !0, this: !0, it: !0, him: !0, her: !0, us: !0 },
      Ys = function (e) {
      ...
      tl = function (e, t, n, r) {
        for (let n = 0; n < e.length; n += 1) {
          let r = Hs(e, n, t);
          ns(e, n, t), (r = r || Os(e, n, t)), (r = r || Ls(e, n, t));
        }
        for (let t = 0; t < e.length; t += 1)
          !0 !== e[t].frozen &&
            (Vs(e, t, n, r),
        ...
        !(function (e, t) {
          ...
          let a = e[0];
          if (
            ("Noun|Verb" === a.switch || a.tags.has("Infinitive")) &&
            e.length >= 2
          ) {
            if (e.length < 4 && !Xs[e[1].normal]) return;
            if (!a.tags.has("PhrasalVerb") && r.hasOwnProperty(a.normal))
              return;
            (e[1].tags.has("Noun") || e[1].tags.has("Determiner")) &&
              ((e.slice(1, 3).some((e) => e.tags.has("Verb")) &&
                !a.tags.has("#PhrasalVerb")) ||
                n([a], "Imperative", t, null, "3-[imperative]"));
          }
        })(e, n);
      },
      nl = {
          ...
          e.docs.forEach((e) => {
            e.forEach((e) => {
              e.penn = (function (e) {
                ...
                let t = e.tagRank || [];
                for (let e = 0; e < t.length; e += 1)
                  if (rl.hasOwnProperty(t[e])) return rl[t[e]];
                return null;
              })(e);
            });
          });
    ...
    const ol = ["Person", "Place", "Organization"];
    var il = {
    ...
    const cl = /[,)"';:\-–—.…]/,
      ...
      pl = /'/,
      fl = new Set(["been", "become"]),
      bl = new Set(["what", "how", "when", "if", "too"]);
    let vl = new Set(["too", "also", "enough"]);
    const yl = function (e, t) {
        let n = e[t].normal.split(pl)[0];
        ...
        return "has" ===
          ((e, t) => {
            for (let n = t + 1; n < e.length; n += 1) {
              let t = e[n];
              if (fl.has(t.normal)) return "has";
              if (bl.has(t.normal)) return "is";
              ...
              if ("Adj|Past" === t.switch && e[n + 1]) {
                if (vl.has(e[n + 1].normal)) return "is";
                if (e[n + 1].tags.has("Preposition")) return "is";
              }
              if (t.tags.has("PastTense"))
                return e[n + 1] && "for" === e[n + 1].normal ? "is" : "has";
            }
            return "is";
          })(e, t)
          ? [n, "has"]
      ...
      wl = /'/,
      kl = new Set(["better", "done", "before", "it", "had"]),
      Pl = new Set(["have", "be"]),
      Al = function (e, t) {
        ...
        return "how" === n || "what" === n
          ...
          : "had" ===
            ((e, t) => {
              for (let n = t + 1; n < e.length; n += 1) {
                let t = e[n];
                if (kl.has(t.normal)) return "had";
                if (Pl.has(t.normal)) return "would";
                if (t.tags.has("PastTense") || "Adj|Past" === t.switch)
                  return "had";
      ...
      Cl = { that: !0, there: !0, let: !0, here: !0, everywhere: !0 },
      Nl = { in: !0, by: !0, for: !0 };
    let jl = new Set(["too", "also", "enough", "about"]),
      xl = new Set([
        "is",
        "are",
        "did",
    ...
    const Il = /'/,
      ...
      Dl = {
        ...
        s: (e, t, n) =>
          ((e, t) => {
            let n = e[t];
            if (Cl.hasOwnProperty(n.machine || n.normal)) return !1;
            ...
            if ("Noun|Gerund" == r.switch) {
              let r = e[t + 2];
              return r
                ? !!r.tags.has("Copula") || ("on" === r.normal || r.normal, !1)
                : !(!n.tags.has("Actor") && !n.tags.has("ProperNoun"));
            }
            if (r.tags.has("Verb"))
              return (
                !!r.tags.has("Infinitive") ||
                (!r.tags.has("Gerund") && !!r.tags.has("PresentTense"))
              );
            if ("Adj|Noun" === r.switch) {
              let n = e[t + 2];
              if (!n) return !1;
              if (xl.has(n.normal)) return !0;
              if (jl.has(n.normal)) return !1;
            }
            if (r.tags.has("Noun")) {
            ...
            if (e[t - 1] && !0 === Nl[e[t - 1].normal]) return !0;
        ...
        contractionTwo: (e) => {
          ...
          n.forEach((r, a) => {
            for (let o = r.length - 1; o >= 0; o -= 1) {
              if (r[o].implicit) continue;
              let i = null;
              !0 === Il.test(r[o].normal) && (i = r[o].normal.split(Il)[1]);
              let s = null;
              Dl.hasOwnProperty(i) && (s = Dl[i](r, o, t)),
                s &&
                  ((s = Hl(s, e)), ml(n, [a, o], s), Tl(n[a], e, o, s.length));
            }
          });
        },
      },
      Gl = {
        ...
        api: function (e) {
          ...
          (e.prototype.contractions = function () {
            ...
            (e.prototype.contract = dl);
        },
        hooks: ["contractionTwo"],
      };
    const Ol = "(hard|fast|late|early|high|right|deep|close|direct)",
      Fl = "(i|we|they)";
    let Vl = [].concat(
        [
          {
        ...
        [
          ...
          {
            match:
              "[#Hyphenated (#Hyphenated && #Gerund)] (#Noun|#Conjunction)",
            group: 0,
            tag: "Adjective",
            notIf: "#Adverb",
            reason: "self-driving",
        ...
        [
          ...
          {
            match:
              "#PresentTense [(hard|quick|bright|slow|fast|backwards|forwards)]",
            notIf: "#Copula",
            group: 0,
            tag: "Adverb",
            reason: "lazy-ly",
        ...
        [
          ...
          {
            match:
              "#Determiner (only|further|just|more|backward) [#Infinitive]",
            group: 0,
            tag: "Noun",
        ...
        [
          ...
          {
            match:
              "(dc|atlanta|minnesota|manchester|newcastle|sheffield) united",
            tag: "SportsTeam",
    ...
    var Bl = {
      postTagger: function (e) {
        const { world: t } = e,
          { model: n, methods: r } = t;
        zl = zl || r.one.buildNet(n.two.matches, t);
        let a = r.two.quickSplit(e.document).map((e) => {
            let t = e[0];
            return [t.index[0], t.index[1], t.index[1] + e.length];
          }),
          o = e.update(a);
        return o.cache(), o.sweep(zl), e.uncache(), e.unfreeze(), e;
      },
      tagger: (e) =>
      ...
      lib: {
        lazy: function (e, t) {
          ...
          let r = this.tokenize(e),
            a = $l(r, n);
          return a.found
            ? (a.compute(["index", "tagger"]), a.match(t))
            : r.none();
        },
      },
    };
    const Ll = function (e, t, n) {
      ...
      return (
        ...
        a.has("#Verb")
          ...
          : a.has("#Adjective")
          ? (function (e, t) {
              const { toComparative: n, toSuperlative: r } =
                e.methods.two.transform.adjective;
              let a = t;
              e.has("#Comparative")
                ? (a = n(a, e.model))
                : e.has("#Superlative") && (a = r(a, e.model)),
                a && e.replaceWith(a);
            })(a, t)
          : this
      );
    ...
    h.plugin(ul), h.plugin(Gl), h.plugin(Sl), h.plugin(Ml), h.plugin(Kl);
    const Jl = function (e) {
    ...
    var Wl = {
        api: function (e) {
          class Adjectives extends e {
            ...
            toComparative(e) {
              const { toComparative: t } = this.methods.two.transform.adjective;
              return this.getNth(e).map((e) => {
                let n = Jl(e),
                  r = t(n, this.model);
            ...
            toSuperlative(e) {
              const { toSuperlative: t } = this.methods.two.transform.adjective;
              return this.getNth(e).map((e) => {
                let n = Jl(e),
                  r = t(n, this.model);
                return e.replaceWith(r);
          ...
          class Adverbs extends e {
            ...
            conjugate(e) {
              return this.getNth(e).map((e) => {
                ...
                return { Adverb: e.text("normal"), Adjective: t };
              }, []);
            }
            json(e = {}) {
    ...
    const Ul = function (e) {
        ...
        return (
          (t = t.splitBefore(r)), "number" == typeof e && (t = t.get(e)), t
        );
      },
    ...
    var Xl = {
        chunks: function (e) {
          ...
          !(function (e) {
            ...
            (function (e, t, n) {
              const { methods: r } = n;
              (Zl = Zl || r.one.buildNet(Ql, n)), e.sweep(Zl);
            })(e, 0, n),
            (function (e) {
              for (let t = 0; t < e.length; t += 1)
                for (let n = 0; n < e[t].length; n += 1) {
          ...
          (e.prototype.chunks = function (e) {
            let t = (function (e) {
              let t = [],
                n = null;
              return (
                e.clauses().docs.forEach((e) => {
                  e.forEach((e) => {
                    e.chunk && e.chunk === n
                      ? (t[t.length - 1][2] = e.index[1] + 1)
                      : ((n = e.chunk),
                        t.push([e.index[0], e.index[1], e.index[1] + 1]));
                  }),
                    (n = null);
                }),
                e.update(t)
    ...
    const eu = /\./g,
        ...
        class Parentheses extends e {
          ...
          strip() {
            return (function (e) {
              return (
                e.docs.forEach((e) => {
                  e[0].pre = e[0].pre.replace(tu, "");
                  let t = e[e.length - 1];
                  t.post = t.post.replace(nu, "");
                }),
                e
              );
            })(this);
      ...
      su = RegExp("[" + Object.keys(iu).join("") + "]"),
      lu = RegExp("[" + Object.values(iu).join("") + "]"),
      uu = function (e, t) {
        const n = e[t].pre.match(su)[0] || "";
        if (!n || !iu[n]) return null;
        const r = iu[n];
        for (; t < e.length; t += 1)
      ...
      cu = function (e) {
        class Quotations extends e {
          ...
          strip() {
            return (function (e) {
              e.docs.forEach((e) => {
                e[0].pre = e[0].pre.replace(su, "");
                let t = e[e.length - 1];
                t.post = t.post.replace(lu, "");
              });
            })(this);
          }
        }
        ...
        !(function (e) {
            ...
            class Possessives extends e {
              ...
              strip() {
                return (
                  this.docs.forEach((e) => {
                    e.forEach((e) => {
                      (e.text = e.text.replace(ou, "")),
                        (e.normal = e.normal.replace(ou, ""));
                    });
                  }),
                  this
                );
          ...
          (function (e) {
            du.forEach((t) => {
              ...
              (e.prototype.phoneNumbers = hu),
              gu.forEach((t) => {
                e.prototype[t[0]] = e.prototype[t[1]];
              });
          })(e),
          (function (e) {
            class Slashes extends e {
              constructor(e, t, n) {
                super(e, t, n), (this.viewType = "Slashes");
              }
              split() {
                return this.map((e) => {
                  let t = e.text().split(mu);
                  return (e = e.replaceWith(t.join(" "))).growRight(
                    "(" + t.join("|") + ")+"
                  );
                });
              }
            }
            e.prototype.slashes = function (e) {
              let t = this.match("#SlashedTerm");
              return (t = t.getNth(e)), new Slashes(t.document, t.pointer);
            };
          })(e);
      },
    };
    ...
    const vu = (e) => e.split("|").reduce((e, t) => ((e[t] = !0), e), {}),
      yu = "unicode|punctuation|whitespace|acronyms",
      wu =
        "|case|contractions|parentheses|quotations|emoji|honorifics|debullet",
      ku = {
        light: vu(yu),
        medium: vu(yu + wu),
        heavy: vu(yu + wu + "|possessives|adverbs|nouns|verbs"),
      };
    var Pu = {
      api: function (e) {
        e.prototype.normalize = function (e = "light") {
          return (
            "string" == typeof e && (e = ku[e]),
            Object.keys(e).forEach((t) => {
              bu.hasOwnProperty(t) && bu[t](this, e[t]);
            }),
            this
          );
        };
    ...
    const Au = [
      ...
      Cu = function (e) {
        ...
        for (let t = 0; t < Au.length; t += 1) if (e.has(Au[t])) return !0;
        return !1;
      },
      Nu = function (e, t) {
      ...
      xu = (e) => e.text(),
      Iu = (e) => e.json({ terms: !1, normal: !0 }).map((e) => e.normal),
      Tu = function (e) {
                  ...
                  t &&
                    ...
                    (n.noun = (function (e) {
                      ...
                      return {
                        root: xu(t.root),
                        number: Tu(t.number),
                        determiner: xu(t.determiner),
                        adjectives: Iu(t.adjectives),
                        isPlural: t.isPlural,
            ...
            conjugate(e) {
              ...
              return this.getNth(e).map((e) => {
                let n = ju(e),
                  ...
                  a = { Singular: r };
                return (
                  Du(n.root) && (a.Plural = t.toPlural(r, this.model)),
                  a.Singular === a.Plural && delete a.Plural,
                  a
                );
              }, []);
            }
            isPlural(e) {
              let t = this.filter((e) => ju(e).isPlural);
              return t.getNth(e);
            }
            isSingular(e) {
              let t = this.filter((e) => !ju(e).isPlural);
            ...
            toPlural(e) {
              return this.getNth(e).map((e) =>
                (function (e, t) {
                  ...
                  if (
                    (t.root.has("#Possessive") &&
                      (t.root = t.root.possessives().strip()),
                    !Du(t.root))
                  )
                    return e;
                  const { methods: n, model: r } = e.world,
                    { toPlural: a } = n.two.transform.noun;
                  let o = a(t.root.text({ keepPunct: !1 }), r);
                  e.match(t.root).replaceWith(o, Hu).tag("Plural", "toPlural"),
            ...
            toSingular(e) {
              return this.getNth(e).map((e) =>
                (function (e, t) {
                  ...
                  const { methods: n, model: r } = e.world,
                    { toSingular: a } = n.two.transform.noun;
                  let o = a(t.root.text("normal"), r);
                  return (
                    e.replace(t.root, o, Eu).tag("Singular", "toPlural"), e
                  );
                })(e, ju(e))
              );
            }
    ...
    const Fu = (e, t) => {
        if (Ou.ones.hasOwnProperty(e)) {
          if (t.ones || t.teens) return !1;
        } else if (Ou.teens.hasOwnProperty(e)) {
          if (t.ones || t.teens || t.tens) return !1;
        } else if (Ou.tens.hasOwnProperty(e) && (t.ones || t.teens || t.tens))
          return !1;
        return !0;
      },
      Vu = function (e) {
        ...
        for (let n = 0; n < e.length; n++) {
          let r = e[n];
          if (!0 === Ou.ones.hasOwnProperty(r)) t += Ou.ones[r];
          else if (!0 === Ou.teens.hasOwnProperty(r)) t += Ou.teens[r];
          else if (!0 === Ou.tens.hasOwnProperty(r)) t += Ou.tens[r];
          else {
      ...
      $u = (e) => Object.keys(e).reduce((t, n) => (t += e[n]), 0),
      Mu = function (e) {
        if (!0 === Su.hasOwnProperty(e)) return Su[e];
        ...
        for (let e = 0; e < i.length; e++) {
          ...
          if (l) {
            ...
            else if (!0 === Ou.ones.hasOwnProperty(s)) r.ones = Ou.ones[s];
            else if (!0 === Ou.teens.hasOwnProperty(s)) r.teens = Ou.teens[s];
            else if (!0 === Ou.tens.hasOwnProperty(s)) r.tens = Ou.tens[s];
            else if (!0 === Ou.multiples.hasOwnProperty(s)) {
              let t = Ou.multiples[s];
              if (t === n) return null;
              if (100 === t && void 0 !== i[e + 1]) {
                const n = i[e + 1];
                Ou.multiples[n] && ((t *= Ou.multiples[n]), (e += 1));
              }
              null === n || t < n
                ? ((a += ($u(r) || 1) * t), (n = t), (r = {}))
                : ((a += $u(r)), (n = t), (a = (a || 1) * t), (r = {}));
    ...
    let Ju = { half: 2, halve: 2, quarter: 4 };
    const Wu = function (e) {
        let t =
          (function (e) {
            let t = e.text("reduced");
            return Ju.hasOwnProperty(t)
          ...
          (function (e) {
            ...
            return (
              Lu.test(a) && ((a = a.replace(Lu, "")), (r = r.replaceWith(a))),
              (r = Ju.hasOwnProperty(a) ? Ju[a] : Ku(r)),
            ...
            return (
              this.getNth(e).forEach((e) => {
                let t = (function (e) {
                  ...
                  let t = _u({ num: e.numerator }),
                    n = Yu({ num: e.denominator });
                  return (
      ...
      tc = "twenty|thirty|forty|fifty|sixty|seventy|eighty|ninety|fourty",
      nc = function (e) {
        let t = e.match("#Value+");
        if (
          ...
          t.has("#Value #Value #Value") &&
            !t.has("#Multiple") &&
            t.has("(" + tc + ") #Cardinal #Cardinal") &&
            (t = t.splitAfter("(" + tc + ") #Cardinal")),
          t.has("#Value #Value"))
        ) {
          ...
          if (
            ...
            let n = t.has(
                `(one|two|three|four|five|six|seven|eight|nine) (${tc})`
              ),
              r = e.has("(" + tc + ") #Cardinal"),
          ...
          t.match("#Ordinal #Ordinal").match("#TextValue").found &&
            !t.has("#Multiple") &&
            (t.has("(" + tc + ") #Ordinal") || (t = t.splitAfter("#Ordinal"))),
      ...
      rc = function (e) {
        if ("string" == typeof e) return { num: Mu(e) };
        let t = e.text("reduced"),
        ...
        let o = null;
        a.found &&
          (a.has("#Value and #Value #Fraction") &&
            (a = a.match("and #Value #Fraction")),
          (o = Wu(a)),
          (t = (e = (e = e.not(a)).not("and$")).text("reduced")));
        let i = 0;
        return (
          t && (i = Mu(t) || 0),
      ...
      ic = function (e) {
        ...
        return (
          ac.hasOwnProperty(e.prefix) &&
            ((t.suffix += " " + ac[e.prefix]), (t.prefix = "")),
          oc.hasOwnProperty(e.suffix) && (t.suffix += " " + oc[e.suffix]),
      ...
      uc = function (e) {
        class Numbers extends e {
          ...
          toNumber() {
            let e = this.map((e) => {
              if (!this.has("#TextValue")) return e;
              let t = rc(e);
              if (null === t.num) return e;
              let n = e.has("#Ordinal") ? "Ordinal" : "Cardinal",
                r = sc(t, n);
              return e.replaceWith(r, { tags: !0 }), e.tag("NumericValue");
            });
          ...
          isEqual(e) {
            return this.filter((t) => rc(t).num === e);
          }
          greaterThan(e) {
            return this.filter((t) => rc(t).num > e);
          }
    ...
    const hc = { people: !0, emails: !0, phoneNumbers: !0, places: !0 },
      dc = function (e = {}) {
        return (
          !1 !== (e = Object.assign({}, hc, e)).people &&
      ...
      pc = function (e) {
        ...
        return (
          ...
          { subj: r, verb: a, pred: o, grammar: mc(a) }
        );
      };
    var fc = {
      api: function (e) {
        class Sentences extends e {
          ...
          json(e = {}) {
            return this.map((t) => {
              let n = t.toView().json(e)[0] || {},
                { subj: r, verb: a, pred: o, grammar: i } = pc(t);
              return (
                (n.sentence = {
    ...
    const bc = function (e) {
      ...
      kc = function (e, t) {
        ...
        if (n.has("#FemaleName")) return yc;
        if (n.has("#MaleName")) return vc;
        if (r.found) {
          let e = r.text("normal");
          if (((e = e.replace(/\./g, "")), wc.hasOwnProperty(e))) return wc[e];
          if (/^her /.test(e)) return yc;
          if (/^his /.test(e)) return vc;
        }
        let a = t.after();
        ...
        !(function (e) {
          ...
          e.prototype.people = function (e) {
            let t = (function (e) {
              ...
              let n = t.match("#Possessive").notIf("(his|her)");
    ...
    const Cc = function (e, t) {
      ...
      Tc = { tense: "PresentTense" },
      Dc = { conditional: !0 },
      Hc = { tense: "FutureTense" },
      Ec = { progressive: !0 },
      Gc = { tense: "PastTense" },
      Oc = { complete: !0, progressive: !1 },
      Fc = { passive: !0 },
      Vc = function (e) {
        let t = {};
        return (
      ...
      zc = {
        ...
        "want-infinitive": [
          ["^(want|wants|wanted) to #Infinitive$", [Tc]],
          ["^wanted to #Infinitive$", [Gc]],
          ["^will want to #Infinitive$", [Hc]],
        ],
        "gerund-phrase": [
          ["^#PastTense #Gerund$", [Gc]],
          ["^#PresentTense #Gerund$", [Tc]],
          ["^#Infinitive #Gerund$", [Tc]],
          ["^will #Infinitive #Gerund$", [Hc]],
          ["^have #PastTense #Gerund$", [Gc]],
          ["^will have #PastTense #Gerund$", [Gc]],
        ],
        "simple-present": [
          ["^#PresentTense$", [Tc]],
          ["^#Infinitive$", [Tc]],
        ],
        "simple-past": [["^#PastTense$", [Gc]]],
        "simple-future": [["^will #Adverb? #Infinitive", [Hc]]],
        "present-progressive": [["^(is|are|am) #Gerund$", [Tc, Ec]]],
        "past-progressive": [["^(was|were) #Gerund$", [Gc, Ec]]],
        "future-progressive": [["^will be #Gerund$", [Hc, Ec]]],
        "present-perfect": [["^(has|have) #PastTense$", [Gc, Oc]]],
        "past-perfect": [
          ["^had #PastTense$", [Gc, Oc]],
          ["^had #PastTense to #Infinitive", [Gc, Oc]],
        ],
        "future-perfect": [["^will have #PastTense$", [Hc, Oc]]],
        "present-perfect-progressive": [
          ["^(has|have) been #Gerund$", [Gc, Ec]],
        ],
        "past-perfect-progressive": [["^had been #Gerund$", [Gc, Ec]]],
        "future-perfect-progressive": [["^will have been #Gerund$", [Hc, Ec]]],
        "passive-past": [
          ["(got|were|was) #Passive", [Gc, Fc]],
          ["^(was|were) being #Passive", [Gc, Fc]],
          ["^(had|have) been #Passive", [Gc, Fc]],
        ],
        "passive-present": [
          ["^(is|are|am) #Passive", [Tc, Fc]],
          ["^(is|are|am) being #Passive", [Tc, Fc]],
          ["^has been #Passive", [Tc, Fc]],
        ],
        "passive-future": [
          ["will have been #Passive", [Hc, Fc, Dc]],
          ["will be being? #Passive", [Hc, Fc, Dc]],
        ],
        "present-conditional": [["would be #PastTense", [Tc, Dc]]],
        "past-conditional": [["would have been #PastTense", [Gc, Dc]]],
        "auxiliary-future": [
          ["(is|are|am|was) going to (#Infinitive|#PresentTense)", [Hc]],
        ],
        "auxiliary-past": [
          ["^did #Infinitive$", [Gc, { plural: !1 }]],
          ["^used to #Infinitive$", [Gc, Oc]],
        ],
        "auxiliary-present": [
          ["^(does|do) #Infinitive$", [Tc, Oc, { plural: !0 }]],
        ],
        "modal-past": [["^(could|must|should|shall) have #PastTense$", [Gc]]],
        "modal-infinitive": [["^#Modal #Infinitive$", []]],
        infinitive: [["^#Infinitive$", []]],
      };
    let Bc = [];
    Object.keys(zc).map((e) => {
      zc[e].forEach((t) => {
        Bc.push({ name: e, match: t[0], data: Vc(t[1]) });
      });
    });
    const Sc = function (e, t) {
        ...
        return (
          ...
          (n.isInfinitive = (function (e) {
            return !(
              !e.has("#Infinitive") || !e.growLeft("to").has("^to #Infinitive")
            );
          })(e)),
          n
        );
      ...
      Lc = function (e) {
        let t = (function (e) {
          ...
          return o.found ||
            ...
            ? o
            : ((r = n.last()),
              $c(r) && (n.remove(r), (r = n.last())),
              $c(r) && (n.remove(r), (r = n.last())),
              r);
        })(e);
        return { subject: t, plural: Mc(t, e) };
      },
      Kc = (e) => e,
      Jc = (e, t) => {
        let n = Lc(e),
      ...
      Rc = function (e, t) {
        ...
        return (r = n(r, e.model, Uc(e))), r && e.replace(t.root, r), e;
      },
      Qc = (e) =>
        e.has("will not")
      ...
      Xc = function (e) {
        ...
        return t(e.text("normal"), e.model, Uc(e));
      },
      Yc = { tags: !0 },
      eh = { tags: !0 },
      th = {
        ...
        simple: (e, t) => {
          const { conjugate: n, toInfinitive: r } =
        ...
        both: function (e, t) {
          return t.negative.found
            ...
            : ((e = th.simple(e, t)), (e = th.noAux(e, t)));
        },
        hasHad: (e) => (e.replace("has", "had", eh), e),
        hasParticiple: (e, t) => {
          const { conjugate: n, toInfinitive: r } =
              e.methods.two.transform.verb,
            a = t.root;
          let o = a.text("normal");
          return (o = r(o, e.model, Uc(a))), n(o, e.model).Participle;
        },
      },
      nh = {
        infinitive: th.simple,
        "simple-present": th.simple,
        "simple-past": Kc,
        "simple-future": th.both,
        "present-progressive": (e) => (
          e.replace("are", "were", eh), e.replace("(is|are|am)", "was", eh), e
        ),
        "past-progressive": Kc,
        "future-progressive": (e, t) => (
          e.match(t.root).insertBefore("was"), e.remove("(will|be)"), e
        ),
        "present-perfect": th.hasHad,
        "past-perfect": Kc,
        "future-perfect": (e, t) => (
        ...
        "present-perfect-progressive": th.hasHad,
        "past-perfect-progressive": Kc,
        "future-perfect-progressive": (e) => (
          e.remove("will"), e.replace("have", "had", eh), e
        ),
        "passive-past": (e) => (e.replace("have", "had", eh), e),
        "passive-present": (e) => (e.replace("(is|are)", "was", eh), e),
        "passive-future": (e, t) => (
          t.auxiliary.has("will be") &&
            (e.match(t.root).insertBefore("had been"), e.remove("(will|be)")),
          t.auxiliary.has("will have been") &&
            (e.replace("have", "had", eh), e.remove("will")),
          e
        ),
        "present-conditional": (e) => (e.replace("be", "have been"), e),
        "past-conditional": Kc,
        "auxiliary-future": (e) => (e.replace("(is|are|am)", "was", eh), e),
        "auxiliary-past": Kc,
        "auxiliary-present": (e) => (e.replace("(do|does)", "did", eh), e),
        "modal-infinitive": (e, t) => (
          e.has("can")
            ? e.replace("can", "could", eh)
            : (th.simple(e, t),
        ...
        "modal-past": Kc,
        "want-infinitive": (e) => (
          e.replace("(want|wants)", "wanted", eh), e.remove("will"), e
        ),
        "gerund-phrase": (e, t) => (
          (t.root = t.root.not("#Gerund$")), th.simple(e, t), Qc(e), e
        ),
      },
      rh = function (e, t) {
        let n = Lc(e),
          r = n.subject;
        return r.has("(i|we|you)")
          ? "have"
          : !1 === n.plural || r.has("he") || r.has("she") || r.has("#Person")
          ? "has"
          : "have";
      },
      ah = (e, t) => {
        const { conjugate: n, toInfinitive: r } = e.methods.two.transform.verb,
      ...
      oh = {
        infinitive: ah,
        "simple-present": ah,
        "simple-future": (e, t) => e.replace("will", rh(e)),
        "present-perfect": Kc,
        "past-perfect": Kc,
        "future-perfect": (e, t) => e.replace("will have", rh(e)),
        "present-perfect-progressive": Kc,
        "past-perfect-progressive": Kc,
        "future-perfect-progressive": Kc,
      },
      ih = { tags: !0 },
      sh = (e, t) => {
        const { conjugate: n, toInfinitive: r } = e.methods.two.transform.verb,
        ...
        return (
          (o = r(o, e.model, Uc(a))),
          !1 === Jc(e) && (o = n(o, e.model).PresentTense),
          a.has("#Copula") && (o = Wc(e)),
          o && (e = e.replace(a, o, ih)).not("#Particle").tag("PresentTense"),
          e
        );
      },
      lh = (e, t) => {
        ...
        return (
          (o = r(o, e.model, Uc(a))),
          !1 === Jc(e) && (o = n(o, e.model).Gerund),
          o && (e = e.replace(a, o, ih)).not("#Particle").tag("Gerund"),
          e
        );
      },
      uh = {
        ...
        "simple-present": (e, t) => {
          ...
          let { root: r } = t;
          if (!r.has("#Infinitive")) return sh(e, t);
          {
            let t = Lc(e).subject;
            if (Jc(e) || t.has("i")) return e;
            let a = r.text("normal"),
              o = n(a, e.model).PresentTense;
            a !== o && e.replace(r, o, ih);
          }
          return e;
        },
        "simple-past": sh,
        "simple-future": (e, t) => {
          ...
          } else sh(e, t), (e = e.remove("will"));
          return e;
        },
        "present-progressive": Kc,
        "past-progressive": (e, t) => {
          let n = Wc(e);
          return e.replace("(were|was)", n, ih);
        },
        "future-progressive": (e) => (
          e.match("will").insertBefore("is"), e.remove("be"), e.remove("will")
        ),
        "present-perfect": (e, t) => (
          sh(e, t), (e = e.remove("(have|had|has)"))
        ),
        "past-perfect": (e, t) => {
          let n = Lc(e).subject;
          return Jc(e) || n.has("i")
            ? ((e = Rc(e, t)).remove("had"), e)
            : (e.replace("had", "has", ih), e);
        },
        "future-perfect": (e) => (
          e.match("will").insertBefore("has"), e.remove("have").remove("will")
        ),
        "present-perfect-progressive": Kc,
        "past-perfect-progressive": (e) => e.replace("had", "has", ih),
        "future-perfect-progressive": (e) => (
          e.match("will").insertBefore("has"), e.remove("have").remove("will")
        ),
        "passive-past": (e, t) => {
        ...
        "present-conditional": Kc,
        "past-conditional": (e) => (e.replace("been", "be"), e.remove("have")),
        "auxiliary-future": (e, t) => (lh(e, t), e.remove("(going|to)"), e),
        "auxiliary-past": (e, t) => {
          if (t.auxiliary.has("did")) {
            let n = qc(e);
            return e.replace(t.auxiliary, n), e;
          }
          return lh(e, t), e.replace(t.auxiliary, "is"), e;
        },
        "auxiliary-present": Kc,
        "modal-infinitive": Kc,
        "modal-past": (e, t) => (
          ((e, t) => {
            const { toInfinitive: n } = e.methods.two.transform.verb,
            ...
            (a = n(a, e.model, Uc(r))), a && (e = e.replace(t.root, a, ih));
          })(e, t),
          e.remove("have")
        ),
        "gerund-phrase": (e, t) => (
          (t.root = t.root.not("#Gerund$")), sh(e, t), e.remove("(will|have)")
        ),
        "want-infinitive": (e, t) => {
          let n = "wants";
          return (
            Jc(e) && (n = "want"),
            e.replace("(want|wanted|wants)", n, ih),
            e.remove("will"),
            e
          );
        },
      ...
      gh = {
        ...
        "simple-past": hh,
        "simple-future": Kc,
        "present-progressive": dh,
        "past-progressive": dh,
        "future-progressive": Kc,
        "present-perfect": (e) => (
        ...
        "modal-past": Kc,
        "gerund-phrase": (e, t) => (
          (t.root = t.root.not("#Gerund$")), hh(e, t), e.remove("(had|have)")
        ),
        "want-infinitive": (e) => (
      ...
      vh = (e) => e.has("(is|was|am|are|will|were|be)"),
      yh = {
        "simple-present": (e, t) =>
          !0 === vh(e) ? bh(e) : ((e = Rc(e, t)), (e = fh(e))),
        "simple-past": (e, t) =>
          !0 === vh(e) ? bh(e) : ((e = Rc(e, t)).prepend("did not"), e),
        imperative: (e) => (e.prepend("do not"), e),
        infinitive: (e, t) => (!0 === vh(e) ? bh(e) : fh(e)),
        "passive-past": (e) => {
          if (e.has("got"))
            return e.replace("got", "get", ph), e.prepend("did not"), e;
        ...
        "want-infinitive": (e, t) =>
          (e = (e = fh(e)).replace("wants", "want", ph)),
      };
    var wh = {
      api: function (e) {
        class Verbs extends e {
            ...
            let n = this.getNth(t).map((t) => {
              ...
              return (
                (n.verb = (function (e) {
                  ...
                  return {
                    root: t.root.text(),
                    preAdverbs: Zc(t.adverbs.pre),
                    postAdverbs: Zc(t.adverbs.post),
                    auxiliary: _c(t.auxiliary),
                    negative: t.negative.found,
                    prefix: _c(t.prefix),
                    infinitive: Xc(t.root),
                    grammar: n,
                  };
                })(t)),
                n
          ...
          subjects(e) {
            return this.getNth(e).map((e) => (Ic(e), Lc(e).subject));
          }
          adverbs(e) {
            return this.getNth(e).map((e) => e.match("#Adverb"));
          }
          isSingular(e) {
            return this.getNth(e).filter((e) => !0 !== Lc(e).plural);
          }
          isPlural(e) {
            return this.getNth(e).filter((e) => !0 === Lc(e).plural);
          }
          ...
          toPresentTense(e) {
            return this.getNth(e).map((e) => {
              let t = Ic(e),
                n = Sc(e, t);
              return n.isInfinitive
                ? e
                : (function (e, t, n) {
                    return uh.hasOwnProperty(n)
                      ? ((e = uh[n](e, t))
                          .fullSentence()
                          .compute(["tagger", "chunks"]),
                        e)
                      : e;
                  })(e, t, n.form);
            });
          ...
          toGerund(e) {
            return this.getNth(e).map((e) => {
              ...
              return n.isInfinitive
                ? e
                : (function (e, t) {
                    const { toInfinitive: n, conjugate: r } =
                        e.methods.two.transform.verb,
                      { root: a, auxiliary: o } = t;
                    ...
                    if (s) {
                      let t = Wc(e);
                      e.replace(a, s, mh), e.remove(o), e.prepend(t);
                    }
                    return (
          ...
          conjugate(e) {
            const { conjugate: t, toInfinitive: n } =
          ...
          toNegative(e) {
            return this.getNth(e).map((e) => {
              ...
              return (function (e, t, n) {
                ...
                if (yh.hasOwnProperty(n)) return yh[n](e, t);
                let r = e.matchOne("be");
                return r.found
                  ? (r.prepend("not"), e)
                  : !0 === vh(e)
          ...
          (e.prototype.verbs = function (e) {
            let t = (function (e) {
              ...
              return (
                ...
                (t = t.splitBefore(
                  "(#PresentTense|#PastTense) [(had|has)]",
                  0
                )),
                (t = t.not("#Reflexive$")),
                (t = t.not("#Adjective")),
    ...
    const kh = function (e, t) {
      ...
      Nh = function (e, t) {
        ...
        return r.found
          ...
          : ((n = Ph(e)),
            (r = t(n)),
            r.found ? r : ((n = Ph(n)), (r = t(n)), r.found ? r : e.none()));
      };
    var jh = {
      compute: {
          ...
          e.pronouns()
            ...
            .forEach((e) => {
              ...
              e.has("(he|him|his)")
                ...
                : e.has("(she|her|hers)")
                ? (t = Nh(e, (e) => Ah(e, "f")))
                : e.has("(they|their|theirs)") && (t = Nh(e, Ch)),
                t &&
                  t.found &&
                  (function (e, t) {
